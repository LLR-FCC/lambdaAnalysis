...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   TString dir    = "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_ccH_inclusive/240/TMVA/jcH/dataset/weights/";
   ...
   theTree->SetBranchStatus("zed_hadronic_subjets_ctag", 1);
   ...
   float _FinalClassifier_BDT_jc;
   //float _FinalClassifier_DNN;
   //float _FinalClassifier_MLP;

   auto _b_classifier_BDT_jc = theTree->Branch("_FinalClassifier_BDT_jc", &_FinalClassifier_BDT_jc, "_FinalClassifier_BDT_jc/F");
   ...
   TFile *target  = new TFile( "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_ccH_inclusive/240/TMVA/jcH/output/TMVApp_WW.root","RECREATE" );
