...
customLabel    = 'e^{+}e^{-} #rightarrow ZH #rightarrow bc + X'
...
outdir         = '/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_ccH_inclusive/240/TMVA/bcH/plots/'
scaleSig       = 1.0
...
variables = ['m_rec', 'jet_ht', 'htheta', 'hrtheta', 'pT1', 'pT2', 'E1', 'E2', 'Eta1', 'Eta2', 'Acoll_ij', 'Jet_No', 'bJet_No', 'pT_ij', 'M_ij', 'zed_bJet_No', 'zed_cJet_No', 'zed_lJet_No', 'MET', 'MET_Angle', 'AcollPaPb_ij', 'DeltaEta', 'DeltaPhi', 'FinalClassifier_BDT_bc', 'cJet_No']
...
#selections['ZH']   = ["selZbcFinal_noBDT", "selZbcFinal", "selZbcFinal2", "selZbcFinal3"]

selections['ZH']   = ["selZbcFinal_noBDT", "selZbcFinal", "selZbcFinal2", "selZbcFinal3", "selZbcFinal4"]
#selections['ZH']   = ["selZbcFinal_noBDT"]
...
extralabel = {}
extralabel['selZbcFinal_noBDT'] = "N_{bZ} = 1, N_{cZ} = 1, M_{Rec} #in #[]{100, 160} GeV, M_{ij} #in #[]{86, 96} GeV"
extralabel['selZbcFinal'] = "selZbcFinal_noBDT cuts, #beta_{bc} > 0.1434"
extralabel['selZbcFinal2'] = "selZbcFinal_noBDT cuts, #beta_{bc} > 0.1434, N_{bJet} > 0"
extralabel['selZbcFinal3'] = "selZbcFinal_noBDT cuts, #beta_{bc} > 0.1434, N_{bJet} > 0, #||{cos(#theta_{Miss})} < 0.98"
extralabel['selZbcFinal4'] = "selZbcFinal_noBDT cuts, #beta_{bc} > 0.1434, N_{bJet} > 0, #||{cos(#theta_{Miss})} < 0.98"
