...
energy         = 365.0
collider       = 'FCC-ee'
inputDir       = '/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_nuenuebb_exclusive/365/presel/'
formats        = ['png']
yaxis          = ['lin','log']
stacksig       = ['stack','nostack']
outdir         = '/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_nuenuebb_exclusive/365/plots/'
scaleSig       = 1.0
...
variables = ['m_rec', 'jet_ht', 'htheta', 'hrtheta', 'pT1', 'pT2', 'E1', 'E2', 'Eta1', 'Eta2', 'Acoll_ij', 'Acoll_PaPb', 'Jet_No', 'bJet_No', 'pT_ij', 'M_ij', 'MET', 'MET_Angle', 'pL_ij', 'pL1', 'pL2']

###Dictonnary with the analysis name as a key, and the list of selections to be plotted for this analysis. The name of the selections should be the same than in the final selection
selections = {}

selections['VBF']   = ["selVBF_noBDT_VetoM", "selVBF_noBDT_NoVetoM", "selVBF_noBDT_Veto", "selVBF_VetoM", "selVBF_NoVetoM", "selVBF_Veto", "selVBF_VetoM2"]
...
extralabel['selVBF_noBDT_Veto'] = "N_{bH} = 2, #||{#Delta #eta} < 3, HT > 20 GeV, MET > 20 GeV, No e or #mu in FS"
