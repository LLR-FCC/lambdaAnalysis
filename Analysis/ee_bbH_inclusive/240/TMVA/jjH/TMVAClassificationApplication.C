...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   TString dir    = "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/TMVA/jjH/dataset/weights/";
   ...
   float _FinalClassifier_BDT_jj;
   //float _FinalClassifier_DNN;
   //float _FinalClassifier_MLP;

   auto _b_classifier_BDT_jj = theTree->Branch("_FinalClassifier_BDT_jj", &_FinalClassifier_BDT_jj, "_FinalClassifier_BDT_jj/F");
   ...
   TFile *target  = new TFile( "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/TMVA/jjH/output/TMVApp.root","RECREATE" );
