...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   TString dir    = "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/TMVA/.old/jbH/dataset/weights/";
   ...
   TFile *target  = new TFile( "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/TMVA/.old/jbH/output/TMVApp_WW.root","RECREATE" );
