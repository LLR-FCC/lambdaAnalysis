...
energy         = 240.0
collider       = 'FCC-ee'
inputDir       = '/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/presel/'
formats        = ['png']
yaxis          = ['lin','log']
stacksig       = ['stack','nostack']
outdir         = '/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/TMVA/.old/jbH/plots/'
scaleSig       = 1.0
...
extralabel = {}
extralabel['selZjbFinal_noBDT'] = "No selection on #beta_{jb}"
extralabel['selZjbFinal'] = "#beta_{jb} > 0.0346"
#extralabel['selZjbFinal2'] = "#beta_{jb} > 0.0221, #||{cos(#theta_{Miss})} < 0.98"
#extralabel['selZjbFinal3'] = "#beta_{jb} > 0.221, #||{cos(#theta_{Miss})} < 0.98"
