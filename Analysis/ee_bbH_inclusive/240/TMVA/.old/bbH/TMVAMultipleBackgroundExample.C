...
//
void Training(){
   std::string factoryOptions( "!V:!Silent:Transformations=I;D;P;G:AnalysisType=Classification" );
   TString fname = "./output/tmva_example_multiple_background.root";
   ...
   TTree *signal      = (TTree*)inputS_qqH->Get("events");
   TTree *background0 = (TTree*)inputB_Zqq->Get("events");
   TTree *background1 = (TTree*)inputB_ZZ->Get("events");
   TTree *background2 = (TTree*)inputB_WW->Get("events");
   ...
   TString outfileName( "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/TMVA/bbH/output/MultiBkg/TMVASignalBackground0.root" );
   ...
   outfileName = "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/TMVA/bbH/output/MultiBkg/TMVASignalBackground1.root";
 ...
 //   dataloader->SetBackgroundWeightExpression("weight");
   ...
   outfileName = "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/TMVA/bbH/output/MultiBkg/TMVASignalBackground2.root";
   outputFile = TFile::Open( outfileName, "RECREATE" );
