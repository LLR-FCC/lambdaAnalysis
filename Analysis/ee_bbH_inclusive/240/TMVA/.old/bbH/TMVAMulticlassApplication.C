...
void TMVAMulticlassApplication( TString myMethodList = "" )
{
   ...
   TString dir    = "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/dataset/weights/";
   ...
   inputS_qqH = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/presel/wzp6_ee_qqH_ecm240.root", "UPDATE");
   inputB_Zqq = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/presel/p8_ee_Zqq_ecm240.root", "UPDATE");
   inputB_ZZ = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/presel/p8_ee_ZZ_ecm240.root", "UPDATE");
   inputB_WW = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/presel/p8_ee_WW_ecm240.root", "UPDATE");
   ...
   float _FinalClassifier_BDTG;
   auto _b_classifier_BDTG = theTree->Branch("_FinalClassifier_BDTG", &_FinalClassifier_BDTG, "_FinalClassifier_BDTG/F");
   ...
   for (Long64_t ievt=0; ievt<theTree->GetEntries();ievt++) {
      ...
      _FinalClassifier_BDTG = (reader->EvaluateMulticlass("BDTG method"))[0];
      _b_classifier_BDTG->Fill();
      //theTree->SetEntries();

      //std::cout << _FinalClassifier_BDTG;
   ...
   TFile *target  = new TFile( "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/TMVA/bbH/output/TMVAMulticlassApp_WW.root","RECREATE" );
   if (Use["MLP"])
