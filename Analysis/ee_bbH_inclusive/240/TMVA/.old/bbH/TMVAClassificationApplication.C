...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   TString dir    = "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/TMVA/.old/bbH/dataset/weights/";
   ...
   float _FinalClassifier_BDT;
   //float _FinalClassifier_DNN;
   //float _FinalClassifier_MLP;

   auto _b_classifier_BDT = theTree->Branch("_FinalClassifier_BDT", &_FinalClassifier_BDT, "_FinalClassifier_BDT/F");
   ...
   TFile *target  = new TFile( "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/TMVA/.old/bbH/output/TMVApp_WW.root","RECREATE" );
