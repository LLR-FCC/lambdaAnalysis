...
class analysis():
    ...
    def run(self):
        df2 = (self.df
               ...
               .Define("selected_bjets",    "JetTaggingUtils::tagsel(1)(jets_kt_btag, jets_kt)")
               ...
               .Define("selected_bjet_ht",  "JetClusteringUtils::get_ht(selected_bjets)")
               ...
               .Define("zed_hadronic",         "JetClusteringUtils::jetResonanceBuilder(91.188)(selected_bjets)")
               .Define("zed_hadronic_subjets", "JetClusteringUtils::get_compositeSubJets(zed_hadronic)")
               .Define("zed_hadronic_subjets_pt1",  "JetClusteringUtils::get_subjetpt(0, zed_hadronic_subjets)")
               .Define("zed_hadronic_subjets_pt2",  "JetClusteringUtils::get_subjetpt(1, zed_hadronic_subjets)")
               .Define("zed_hadronic_subjets_E1",  "JetClusteringUtils::get_subjetE(0, zed_hadronic_subjets)")
               .Define("zed_hadronic_subjets_E2",  "JetClusteringUtils::get_subjetE(1, zed_hadronic_subjets)")
               .Define("zed_hadronic_subjets_Eta1",  "JetClusteringUtils::get_subjetEta(0, zed_hadronic_subjets)")
               .Define("zed_hadronic_subjets_Eta2",  "JetClusteringUtils::get_subjetEta(1, zed_hadronic_subjets)")
               .Define("zed_hadronic_subjets_theta",  "JetClusteringUtils::get_theta(zed_hadronic_subjets)")
               .Define("zed_hadronic_subjets_acoll",  "JetClusteringUtils::get_subjetAcoll(zed_hadronic_subjets)")
               .Define("zed_hadronic_jetNo",  "JetClusteringUtils::get_jetNo(jets_kt)")
               .Define("zed_hadronic_bjetNo",  "JetClusteringUtils::get_jetNo(selected_bjets)")
