...
customLabel    = 'e^{+}e^{-} #rightarrow ZH #rightarrow #mu^{+}#mu^{-} + X'
delphesVersion = '3.4.2'
energy         = 240.0
collider       = 'FCC-ee'
inputDir       = '/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_mumuH_inclusive/240/presel/'
formats        = ['png']
yaxis          = ['lin','log']
stacksig       = ['stack','nostack']
outdir         = '/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_mumuH_inclusive/240/plots/'
scaleSig       = 1.0
ana_tex        = ''
...
extralabel['sel5'] = "p_{Tij} #in #[]{20, 70} GeV, #||{cos(#theta_{Miss})} < 0.98"
