...
baseDir  = "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_mumuH_inclusive/240/presel/"
...
cut_list = {"sel0":"zed_leptonic_m.size() == 1 && zed_leptonic_charge[0] == 0",
            ...
            "sel5":"zed_leptonic_m.size() == 1 && zed_leptonic_m[0] > 86 &&  zed_leptonic_m[0] < 96 && zed_leptonic_recoil_m[0] > 120 && zed_leptonic_recoil_m[0] < 150 && zed_leptonic_pt[0] > 20 && zed_leptonic_pt[0] < 70 && missingET_costheta.size() ==1 && missingET_costheta[0] > -0.98 && missingET_costheta[0] < 0.98 && zed_leptonic_charge[0] == 0"
            }
...
variables = {
    ...
    "leptonic_recoil_m_zoom6":{"name":"zed_leptonic_recoil_m","title":"M_{Rec} [GeV]","bin":100,"xmin":120,"xmax":150},
    "leptonic_pt"           :{"name":"zed_leptonic_pt"      ,"title":"p_{Tij} [GeV]" ,"bin":100,"xmin":20, "xmax":70},
