...
outdir="/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_mumuH_inclusive/365/presel/"

import multiprocessing
NUM_CPUS = int(multiprocessing.cpu_count()-2)

process_list=['wzp6_ee_mumuH_ecm365','p8_ee_WW_ecm365','p8_ee_ZZ_ecm365','wzp6_gaga_mumu_60_ecm365']
fraction=1
