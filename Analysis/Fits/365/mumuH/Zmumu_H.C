...
void Zmumu_H() {
   ...
   TFile *mumuFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/365/presel/histos/wzp6_ee_mumuH_ecm365_sel_ZmumuH4_histo.root");
   TFile *WWFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/365/presel/histos/p8_ee_WW_ecm365_sel_ZmumuH4_histo.root");
   TFile *ZZFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/365/presel/histos/p8_ee_ZZ_ecm365_sel_ZmumuH4_histo.root");
   //TFile *ZllFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/365/presel/histos/p8_ee_Zll_ecm365_sel_ZmumuH4_histo.root");
   //TFile *ZeeFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/365/presel/histos/wzp6_ee_ee_Mee_30_150_ecm365_sel_ZmumuH4_histo.root");
   TFile *ZmumuFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/365/presel/histos/wzp6_ee_mumu_ecm365_sel_ZmumuH4_histo.root");
   //TFile *ZtautauFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/365/presel/histos/wzp6_ee_tautau_ecm365_sel_ZmumuH4_histo.root");
   //TFile *gagaFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/365/presel/histos/wzp6_gaga_mumu_60_ecm365_sel_ZmumuH4_histo.root");

   TH1D *h = (TH1D*)mumuFile->Get("leptonic_recoil_m_zoom1");
   ...
   //TH1D *hgaga = (TH1D*)gagaFile->Get("leptonic_recoil_m_zoom1");
   ...
   mrec.setConstant();
   RooRealVar a0_365GeV("a0_365GeV", "a0_365GeV",0.,-10.,10.);
   RooRealVar a1_365GeV("a1_365GeV", "a1_365GeV",0.,-1,1);
   //RooRealVar a2_365GeV("a2_365GeV", "a2_365GeV",0.,-1,1);
   //RooRealVar a3_365GeV("a3_365GeV", "a3_365GeV",0.,-1,1);

    //RooChebychev bkgModel("bkgModel","Chebychev model",mrec,{a0,a1,a2,a3});
   RooPolynomial bkgModel("bkgModel","Polynomial model",mrec,RooArgList(a0_365GeV,a1_365GeV));
   ...
   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    TFile *mumuFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/source/wzp6_ee_mumuH_ecm365_sel_ZmumuH4_noRVec.root");
    TFile *WWFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/source/p8_ee_WW_ecm365_sel_ZmumuH4_noRVec.root");
    TFile *ZZFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/source/p8_ee_ZZ_ecm365_sel_ZmumuH4_noRVec.root");
    //TFile *ZllFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/source/p8_ee_Zll_ecm365_sel_ZmumuH4_noRVec.root");
    //TFile *ZeeFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/source/wzp6_ee_ee_Mee_30_150_ecm365_sel_ZmumuH4_noRVec.root");
    TFile *ZmumuFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/source/wzp6_ee_mumu_ecm365_sel_ZmumuH4_noRVec.root");
    //TFile *ZtautauFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/source/wzp6_ee_tautau_ecm365_sel_ZmumuH4_noRVec.root");
    //TFile *gagaFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/source/wzp6_gaga_mumu_60_ecm365_sel_ZmumuH4_noRVec.root");

    RooFormulaVar wFuncHZ("weight_T1","weight_T","(0.0313875)",mrec) ;
  ...
  //RooKeysPdf bkgModel("bkgModel","KDE model",mrec,wdataHZ);
   ...
   c1 -> cd();
   RooPlot * frame =  mrec.frame(Name("Mrecframe"), Title("Background-only Data"));
   wdataWW.plotOn(frame,DataError(RooAbsData::SumW2));
   frame->Draw();
   c1->Draw();
   c1->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/aplots/data.pdf");



   // S+ B fit in background region 
   RooRealVar N_365GeV("N_365GeV", "Extended term", nbkgMC_365GeV,0,45000);
   //RooRealVar N("N", "Extended term", nbkgMC_365GeV,nbkgMC_365GeV - 5000,nbkgMC_365GeV + 5000);
   
   //Definition of the extended model
   RooExtendPdf extmodel("extmodel", "Extended model", bkgModel, N_365GeV, "FULL");
   ...
   frame2->Draw();
   c2->Draw();
   c2->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/aplots/bkg_only.pdf");   
   a0_365GeV.setConstant(kTRUE);
   a1_365GeV.setConstant(kTRUE);
   //a2.setConstant(kTRUE);
   //a3.setConstant(kTRUE); 
   
   //N_365GeV.setVal(nbkgMC_365GeV);
   N_365GeV.setConstant(kTRUE);
   ...
   RooRealVar COMmess_365GeV("COMmess_365GeV", "measured COM energy", 1., 1. - (365*0.0000012), 1. + (365*0.0000012)); //0.00012
   RooGaussian COMsmear_365GeV("COMsmear_365GeV", "COM smearing", RooConst(1.), COMmess_365GeV, RooConst(0.000012)); // 0.0012
   ...
   RooConstVar Eideal_365GeV("Eideal_365GeV", "ideal Efficiency", 0.410455);
   RooRealVar Emess_365GeV("Emess_365GeV", "Efficiency_mess", 1., 1. - (30*0.001), 1. + (30*0.001)); 
   ...
   // BR smearing @ 365 GeV
   RooConstVar BRideal_365GeV("BRideal_365GeV","BRideal_365GeV",1.); //??? 0.0336
   ...
   RooRealVar sigma_365GeV("sigma", "sigma", 0.5, 0.1, 2);
   RooRealVar alphaL_365GeV("alphaL", "alphaL", 1., -1, 10);
   RooRealVar alphaR_365GeV("alphaR", "alphaR", 1., -1, 10);
   RooRealVar NL_365GeV("NL", "NL", 3., 0.5, 10.); //4.6, 0.1, 20
   RooRealVar NR_365GeV("NR", "NR", 3., 0.5, 10.);
   
   RooRealVar mean2_365GeV("mean2_365GeV", "mean2", 125, 123, 127);
   RooRealVar sigma2_365GeV("sigma2_365GeV", "sigma2", 0.8, 0.1, 1.5); // 0.8, 0.1, 2
   ...
   RooAddPdf sig_365GeV("finalsig_365GeV", "final signal", RooArgList(CB1sig_365GeV, CB2sig_365GeV, gauss_365GeV), RooArgList(fsig, fsig2), true);

   
   // NLO CS @ 365 GeV
   RooConstVar CSTrue_365GeV("CSTrue_365GeV", "CS_True", 0.004185); // in pb 0.0067643
   RooConstVar CSLO_365GeV("CSLO_365GeV", "CS_LO", 0.004167663); // in pb 0.006661471998033432 approx. CSTrue_365GeV / (1 + C1 + dZh)
   ...
   RooProduct muZHsig_365GeV("muZHsig_365GeV", "muZH_365GeV * varL_365GeV * varE_365GeV * (CSTrue_365GeV * BRideal_365GeV)", RooArgList(muZH_365GeV, varL_365GeV, varE_365GeV, CSTrue_365GeV, BRideal_365GeV));

   //RooProduct muZHsig_365GeV("muZHsig", "muZH_365GeV * nsigTrue_365GeV", RooArgList(muZH_365GeV, nsigTrue_365GeV));

   
   RooAddPdf modelBare_365GeV("modelBare", "(g1+g2)+a", RooArgList(bkgModel, sig_365GeV), RooArgList(N_365GeV, muZHsig_365GeV));
   ...
   RooFitResult* r3 = model_365GeV.fitTo(wdataHZ,Save(), Extended(kTRUE), ExternalConstraints(RooArgSet(Lsmear_365GeV, Esmear_365GeV, BRsmear_365GeV, COMsmear_365GeV, mHsmear_365GeV)), Offset(kTRUE), NumCPU(8, 0), Minimizer("Minuit","migradimproved"), GlobalObservables(RooArgSet(Lmess_365GeV, Emess_365GeV, COMmess_365GeV, BRmess_365GeV)), Strategy(2));
   //RooFitResult* r3 = model_365GeV.fitTo(wdataHZsig,Save(), Extended(kTRUE), PrintEvalErrors(-1), Offset(kTRUE), NumCPU(8, 0), Minimizer("Minuit","migrad"), GlobalObservables(RooArgSet(Lmess_365GeV, Emess_365GeV, COMmess_365GeV, BRmess_365GeV)), Strategy(2));
   
   //RooFitResult* r3 = model_365GeV.fitTo(dh, Range("FULL"),Save(), Extended(kTRUE), ExternalConstraints( RooArgSet( mHsmear_365GeV)), IntegrateBins(0.));
   ...
   model_365GeV.plotOn(frame3, LineColor(kAzure-2), Bins(70));       //modelsum.
   //modelsum.plotOn(frame3,VisualizeError(*r3));
   //modelsum.plotOn(frame3,VisualizeError(*r3, 2, kFALSE),FillColor(kOrange)); 
   model_365GeV.plotOn(frame3,Components(bkgModel), LineColor(kGreen+2),LineStyle(kDashed),Name("Bkg only") , Bins(70));
   model_365GeV.plotOn(frame3,Components(sig_365GeV), LineColor(kRed-4),LineStyle(kDotted),  Name("Sgn Comp1 only") , Bins(70));
   ...
   model_365GeV.plotOn(frame3,Components(CB1sig_365GeV), LineColor(kOrange-8),LineStyle(kDashed), Name("Sgn CB1 only") );
   //model_365GeV.plotOn(frame3,Components(sig2), LineColor(kViolet-4),LineStyle(kDashDotted), Name("Sgn Comp2 only") );
   
   // model_365GeV.paramOn(frame3, Label("S+B fit"));     //modelsum
   frame3->Draw();
   
   c3->Draw();
   c3->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/aplots/S_B_fit.pdf");
   ...
   params->printLatex(Sibling(*initParams), OutputFile("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/aplots/latextables.tex"));
   ...
   framecorr->Draw();
   ccorr->Draw();
   ccorr->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/aplots/corr.eps"); 
 ...
 c31->Draw();
 c31->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/aplots/pulls_resid.pdf");
 ...
 c->cd();
 c->Draw();
 c->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/aplots/Fit_pulls.pdf");
 ...
 w->defineSet("np", RooArgSet(sigma_365GeV, alphaL_365GeV, alphaR_365GeV, NL_365GeV, NR_365GeV, mean2_365GeV, sigma2_365GeV, fsig, fsig2, N_365GeV, mHmess_365GeV), kTRUE);
 ...
 std::cout << "Asimov designed for mu = 1 gave mu-hat = " << w->var("muZH_365GeV")->getVal() << std::endl;
   ...
   frame7->Draw();
   c7->Draw();
   c7->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/aplots/adata.pdf");
  ...
  w->writeToFile("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/ZmumuH365_muZH.root");
...
/*
 ...
 TCanvas* c5 = new TCanvas ("c5", "c5", 100, 200, 700, 500);
  ...
  //sigma_365GeV.setConstant(kTRUE);
   //alphaL_365GeV.setConstant(kTRUE);
   //alphaR_365GeV.setConstant(kTRUE);
   //NL_365GeV.setConstant(kTRUE);
   //NR_365GeV.setConstant(kTRUE);
   //mean2_365GeV.setConstant(kTRUE);
   //sigma2_365GeV.setConstant(kTRUE);


 // Construct unbinned likelihood
 //RooAbsReal * nll = model_365GeV.createNLL(dh, Extended(kTRUE), Offset(kTRUE));
 //RooAbsReal * nll = model_365GeV.createNLL(dh, Extended(kTRUE), ExternalConstraints( RooArgSet( mHsmear_365GeV,varKappasmear_365GeV)));
 
 

 //RooAbsReal * nll = model_365GeV.createNLL(dh, Extended(kTRUE), ExternalConstraints( RooArgSet( mHsmear_365GeV,varKappasmear_365GeV)), IntegrateBins(0.));
 //RooAbsReal * nll = model_365GeV.createNLL(dh, Extended(kTRUE), ExternalConstraints( RooArgSet( mHsmear_365GeV)), IntegrateBins(0.)); //Best Result
 ...
 //RooAbsReal * nll = model_365GeV.createNLL(*asimov, Save(), Extended(kTRUE), ExternalConstraints(RooArgSet(Lsmear_365GeV, Esmear_365GeV, COMsmear_365GeV)), Offset(kTRUE), NumCPU(8, 0)); 
 RooAbsReal * nll = model_365GeV.createNLL(*asimov, Save(), Extended(kTRUE), ExternalConstraints(RooArgSet(Lsmear_365GeV, Esmear_365GeV, COMsmear_365GeV, BRsmear_365GeV)), Offset(kTRUE), NumCPU(8, 0)); 
 ...
 // Plot likelihood scan in Nsig
  RooPlot *frame4 = varKappa_365GeV.frame(Range(-20., 20.), Title("NLL in #delta#kappa_{#lambda} "));
...
// C o n s t r u c t   p r o f i l e   l i k e l i h o o d   i n   m u  Z H
 ...
 frame6->Draw(); 
 c6->Draw(); 
 c6->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/aplots/NLL_prf_muZH.pdf");
 ...
 */
 ...
 frame4->Draw(); 
 c4->Draw(); 
 c4->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/aplots/NLL_prf_kl.pdf");
...
*/
 ...
 frame5->Draw();
 c5->Draw();
 c5->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/aplots/NLL_prf_mh.eps");
 */
 ...
 frame6->Draw();
 c6->Draw();
 c6->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/365/mumuH/aplots/contour_kl_mH.pdf");
