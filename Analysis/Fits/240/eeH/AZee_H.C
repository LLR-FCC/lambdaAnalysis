...
void AZee_H() {
   ...
   TFile *eeFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/wzp6_ee_eeH_ecm240_sel_ZeeH4_histo.root");
   TFile *WWFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/p8_ee_WW_ecm240_sel_ZeeH4_histo.root");
   TFile *ZZFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/p8_ee_ZZ_ecm240_sel_ZeeH4_histo.root");
   //TFile *ZllFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/p8_ee_Zll_ecm240_sel_ZeeH4_histo.root");
   TFile *ZeeFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/wzp6_ee_ee_Mee_30_150_ecm240_sel_ZeeH4_histo.root");
   TFile *ZmumuFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/wzp6_ee_mumu_ecm240_sel_ZeeH4_histo.root");
   TFile *ZtautauFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/wzp6_ee_tautau_ecm240_sel_ZeeH4_histo.root");

   TH1D *h = (TH1D*)eeFile->Get("leptonic_recoil_m_zoom6");
   ...
   TFile *eeFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/source/wzp6_ee_eeH_ecm240_sel_ZeeH4_noRVec.root");
   TFile *WWFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/source/p8_ee_WW_ecm240_sel_ZeeH4_noRVec.root");
   TFile *ZZFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/source/p8_ee_ZZ_ecm240_sel_ZeeH4_noRVec.root");
   //TFile *ZllFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/source/p8_ee_Zll_ecm240_sel_ZeeH4_noRVec.root");
   TFile *ZeeFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/source/wzp6_ee_ee_Mee_30_150_ecm240_sel_ZeeH4_noRVec.root");
   //TFile *ZmumuFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/source/wzp6_ee_mumu_ecm240_sel_ZeeH4_noRVec.root");
   TFile *ZtautauFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/source/wzp6_ee_tautau_ecm240_sel_ZeeH4_noRVec.root");

    RooFormulaVar wFuncHZ("weight_T1","weight_T","(0.039783889)",mrec) ;
    //RooRealVar weight_T("weight_T", "weight_T", 0.039783889);
   ...
   c1 -> cd();
   RooPlot * frame =  mrec.frame(Name("Mrecframe"), Title("Data"), Bins(60));
   wdataHZ.plotOn(frame,DataError(RooAbsData::SumW2));
   frame->Draw();
   c1->Draw();
   c1->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/aplots/data.pdf");

   

   // S+ B fit in background region 
   RooRealVar N("N", "Extended term", nbkgMC_240GeV,0,55000);
   ...
   frame2->Draw();
   c2->Draw();
   c2->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/aplots/bkg_only.pdf");   
   ...
   RooRealVar COMmess_240GeV("COMmess_240GeV", "measured COM energy", 1., 1. - (240*0.0000012), 1. + (240*0.0000012));
   RooGaussian COMsmear_240GeV("COMsmear_240GeV", "COM smearing", RooConst(1.), COMmess_240GeV, RooConst(0.000012)); // 0.056
   ...
   RooConstVar Eideal_240GeV("Eideal_240GeV", "ideal Efficiency", 0.330868889);
   ...
   // BR smearing @ 240 GeV
   RooConstVar BRideal_240GeV("BRideal_240GeV","BRideal_240GeV",1.);
   ...
   //RooRealVar sigma_240GeV("sigma", "sigma", 0.9, 0.2, 1.0);
   //RooRealVar alphaL_240GeV("alphaL", "alphaL", 1., 0.1, 5);
   //RooRealVar alphaR_240GeV("alphaR", "alphaR", 1., 0.1, 5);
   //RooRealVar NL_240GeV("NL", "NL", 1.5, 0.1, 50.); //4.6, 0.1, 20
   //RooRealVar NR_240GeV("NR", "NR", 0.5, 0.1, 50.);
   
   //RooRealVar mean2_240GeV("mean2_240GeV", "mean2", 128, 125, 130);
   //RooRealVar sigma2_240GeV("sigma2_240GeV", "sigma2", 0.9, 0.2, 1.0);
   //RooGaussian sig2_240GeV("sig2_240GeV", "Signal2", mrec, mean2_240GeV, sigma2_240GeV);
   //RooRealVar fsig("fsig", "signal fraction", 0.5, 0., 1.);

   //RooCrystalBall CBsig_240GeV("sig", "Signal", mrec, mean_240GeV, sigma_240GeV, alphaL_240GeV, NL_240GeV, alphaR_240GeV, NR_240GeV);

   //RooAddPdf sig_240GeV("finalsig", "final signal", RooArgList(CBsig_240GeV, sig2_240GeV), fsig);

   RooFormulaVar mean_240GeV("mean", "sqrt((( @0)^2)*@2  + ((@3)^2) + ((@1)^2) - (@2)*((@3)^2 + ((@1)^2)/((@2)^2)))", RooArgSet(mHmess_240GeV,COMideal_240GeV,COMmess_240GeV,mZ));
   RooRealVar sigma_240GeV("sigma", "sigma", 0.55, 0.1, 2);
   RooRealVar alphaL_240GeV("alphaL", "alphaL", 1., -1, 10);
   RooRealVar alphaR_240GeV("alphaR", "alphaR", 1., -1, 10);
   RooRealVar NL_240GeV("NL", "NL", 3., 0.1, 20.); //4.6, 0.1, 20
   RooRealVar NR_240GeV("NR", "NR", 3., 0.1, 20.);
   
   RooRealVar mean2_240GeV("mean2_240GeV", "mean2", 125, 123, 140);
   ...
   // NLO CS @ 240 GeV
   RooConstVar CSTrue_240GeV("CSTrue_240GeV", "CS_True", 0.0071611); // in pb 0.0071611
   RooConstVar CSLO_240GeV("CSLO_240GeV", "CS_LO", 0.007052074921710359); // in pb
   ...
   //NL_240GeV.removeRange();
   //NR_240GeV.removeRange();
   
   RooFitResult* r3 = model_240GeV.fitTo(wdataHZ,Save(), Extended(kTRUE), ExternalConstraints(RooArgSet(Lsmear_240GeV, Esmear_240GeV, COMsmear_240GeV, BRsmear_240GeV, mHsmear_240GeV)), Offset(kTRUE), NumCPU(8, 0), Minimizer("Minuit2","migrad"), GlobalObservables(RooArgSet(Lmess_240GeV, Emess_240GeV, COMmess_240GeV, BRmess_240GeV)), Strategy(2)); //, Minimizer("Minuit2","migrad") Minos???, Strategy(2)
   ...
   model_240GeV.plotOn(frame3, LineColor(kAzure-2));       //modelsum.
   //modelsum.plotOn(frame3,VisualizeError(*r3));
   //modelsum.plotOn(frame3,VisualizeError(*r3, 2, kFALSE),FillColor(kOrange)); 
   
   model_240GeV.plotOn(frame3,Components(bkgModel), LineColor(kGreen+2),LineStyle(kDashed),Name("Bkg only") );
   model_240GeV.plotOn(frame3,Components(sig_240GeV), LineColor(kRed-4),LineStyle(kDotted),  Name("Sgn only") );
   ...
   c3->Draw();
   c3->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/aplots/S_B_fit.pdf");
   ...
   params->printLatex(Sibling(*initParams), OutputFile("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/aplots/latextables.tex"));
   ...
   framecorr->Draw();
   ccorr->Draw();
   ccorr->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/aplots/corr.eps"); 
 ...
 c31->Draw();
 c31->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/aplots/pulls_resid.pdf");
 ...
 c->cd();
 c->Draw();
 c->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/aplots/Fit_pulls.pdf");
 ...
 RooFitResult * r4 = w->pdf("model")->fitTo(*asimov,Save(), Extended(kTRUE), ExternalConstraints(RooArgSet(Lsmear_240GeV, Esmear_240GeV, COMsmear_240GeV, mHsmear_240GeV, BRsmear_240GeV)), Offset(kTRUE), NumCPU(8, 0), Minimizer("Minuit","migrad"), GlobalObservables(RooArgSet(Lmess_240GeV, Emess_240GeV, COMmess_240GeV, BRmess_240GeV, mHmess_240GeV)), Strategy(2));
 ...
 r4->Print();
  ...
  // Plot Asimov
   ...
   frame7->Draw();
   c7->Draw();
   c7->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/aplots/adata.pdf");
  ...
  w->import(*asimov_bare, Rename("eeH_Asimov_bare"));

  RooArgSet *asimov_parameters_bare = (RooArgSet*)w->pdf("modelBare")->getParameters(mrec);
  w->saveSnapshot("eeH_asimovFit_bare", *asimov_parameters_bare, kTRUE);
  ...
  w->writeToFile("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/ZeeH240_muZH.root");
...
/*
 ...
 //RooAbsReal * nll = model_240GeV.createNLL(dh, Extended(kTRUE), Offset(kTRUE), ExternalConstraints( RooArgSet( mHsmear_240GeV,varKappasmear_240GeV)));
 
 //RooAbsReal * nll = model_240GeV.createNLL(wdataHZ, Extended(kTRUE), ExternalConstraints( RooArgSet( mHsmear_240GeV))); //Best Result
 ...
 // Minimize likelihood w.r.t all parameters before making /afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/aplots
 ...
 // Plot likelihood scan in Nsig
  RooPlot *frame4 = varKappa_240GeV.frame(Range(-8., 17.), Title("NLL in #delta#kappa_{#lambda} "));
...
// C o n s t r u c t   p r o f i l e   l i k e l i h o o d   i n   m u  Z H
 ...
 frame6->Draw(); 
 c6->Draw(); 
 c6->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/aplots/NLL_prf_muZH.pdf");
 ...
 frame4->Draw(); 
 c4->Draw(); 
 c4->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/aplots/NLL_prf_kl.pdf");
 ...
 */
 ...
 frame5->Draw();
 c5->Draw();
 c5->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/aplots/NLL_prf_mh.eps");
 */
 ...
 frame6->Draw();
 c6->Draw();
 c6->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/aplots/contour_kl_mH.pdf");
