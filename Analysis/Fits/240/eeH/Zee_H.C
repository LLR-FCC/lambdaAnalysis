...
void Zee_H() {
   ...
   TFile *ZllFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/source/p8_ee_Zll_ecm240_sel_ZeeH4_noRVec.root");
    ...
    dataHZ -> Print();
    RooDataSet wdataHZ("wdataHZ", "wdataHZ", dataHZ, *dataHZ->get(), 0, weight_T->GetName());
    wdataHZ.Print();
    ...
    RooRealVar * weight_T3 = (RooRealVar *)dataZll->addColumn(wFuncZll);
    dataZll -> Print();
    RooDataSet wdataZll(dataZll->GetName(), dataZll->GetTitle(), dataZll, *dataZll->get(), 0, weight_T3->GetName());
    wdataZll.Print();
    cout << wdataZll.isWeighted() << endl;
   ...
   frame->Draw();
   c1->Draw();
   c1->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/plots/data.pdf");

   

   // S+ B fit in background region 
   RooRealVar N("N", "Extended term", nbkgMC_240GeV,25000,55000);
   ...
   RooFitResult* r2 = extmodel.fitTo(wdataHZ, Range("LEFT,RIGHT") ,Save());
   r2->Print();
   RooPlot* frame2 = mrec.frame(Name("m_recoil_frame"), Title("Fit sidebands"));
   wdataHZ.plotOn(frame2);
   extmodel.plotOn(frame2,LineColor(kGreen+2));
   // extmodel.plotOn(frame2, VisualizeError(*r2));
   extmodel.paramOn(frame2, Label("Extended B fit. in Bkg region"));                                                                                
   frame2 -> GetXaxis()->SetRangeUser(120, 140);
   frame2->Draw();
   c2->Draw();
   c2->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/plots/bkg_only.pdf");   
   ...
   RooFormulaVar mean_240GeV("mean", "sqrt((( @0)^2)*@2  + ((@3)^2) + ((@1)^2) - (@2)*((@3)^2 + ((@1)^2)/((@2)^2)))", RooArgSet(mHmess_240GeV,COMideal_240GeV,COMmess_240GeV,mZ));
   RooRealVar sigma_240GeV("sigma", "sigma", 0.9, 0.01, 1.0);
   RooRealVar alphaL_240GeV("alphaL", "alphaL", 1., 0.1, 5);
   RooRealVar alphaR_240GeV("alphaR", "alphaR", 1., 0.1, 5);
   RooRealVar NL_240GeV("NL", "NL", 1.5, 0.1, 50.); //4.6, 0.1, 20
   RooRealVar NR_240GeV("NR", "NR", 0.5, 0.1, 50.);
   ...
   RooRealVar mean2_240GeV("mean2_240GeV", "mean2", 128, 125, 130);
   RooRealVar sigma2_240GeV("sigma2_240GeV", "sigma2", 0.9, 0.01, 5.0);
   ...
   //RooProduct muZHsig_240GeV("muZHsig", "muZH_240GeV * varL_240GeV * varE_240GeV * (CSLO_240GeV * BRideal_240GeV)", RooArgList(muZH_240GeV, varL_240GeV, varE_240GeV, CSLO_240GeV, BRideal_240GeV));
   ...
   //RooFitResult* r3 = model_240GeV.fitTo(wdataHZ, Range("FULL"),Save(), Extended(kTRUE));

   //RooFitResult* r3 = model_240GeV.fitTo(dh, Range("FULL"),Save(), ExternalConstraints( RooArgSet(mHsmear_240GeV,varKappasmear_240GeV)));
   
   RooPlot* frame3 = mrec.frame(Name("Mrecframe"), Title("S+B fit"));
   ...
   model_240GeV.plotOn(frame3,Components(sig_240GeV), LineColor(kRed-4),LineStyle(kDotted),  Name("Sgn Comp1 only") );
   ...
   c3->Draw();
   c3->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/plots/S_B_fit.pdf");
   ...
   params->printLatex(Sibling(*initParams), OutputFile("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/plots/latextables.tex"));
   ...
   framecorr->Draw();
   ccorr->Draw();
   ccorr->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/plots/corr.eps"); 
 ...
 c31->Draw();
 c31->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/plots/pulls_resid.pdf");
 ...
 c->cd();
 c->Draw();
 c->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/plots/Fit_pulls.pdf");
 ...
 w->writeToFile("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/ZeeH240.root");
...
/*
 ...
 // Minimize likelihood w.r.t all parameters before making /afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/plots
...
// C o n s t r u c t   p r o f i l e   l i k e l i h o o d   i n   m u  Z H
 ...
 frame6->Draw(); 
 c6->Draw(); 
 c6->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/plots/NLL_prf_muZH.pdf");
 ...
 frame4->Draw(); 
 c4->Draw(); 
 c4->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/plots/NLL_prf_kl.pdf");
 ...
 */
 ...
 frame5->Draw();
 c5->Draw();
 c5->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/plots/NLL_prf_mh.eps");
 */
 ...
 frame6->Draw();
 c6->Draw();
 c6->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/eeH/plots/contour_kl_mH.pdf");
