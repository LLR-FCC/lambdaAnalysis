...
void Zmumu_H() {
   ...
   TFile *mumuFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/wzp6_ee_mumuH_ecm240_sel_ZmumuH4_histo.root");
   TFile *WWFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/p8_ee_WW_ecm240_sel_ZmumuH4_histo.root");
   TFile *ZZFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/p8_ee_ZZ_ecm240_sel_ZmumuH4_histo.root");
   TFile *ZllFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/p8_ee_Zll_ecm240_sel_ZmumuH4_histo.root");
   TFile *gagaFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/wzp6_gaga_mumu_60_ecm240_sel_ZmumuH4_histo.root");
   ...
   hh->Add(hZZ);
   hh->Add(hZll);
   hh->Add(hgaga); //Normalisierung falsch!!!
   ...
   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    RooFormulaVar wFuncgaga("weight_T5","weight_T","(0.258716667)",mrec) ;
    ...
    RooRealVar * weight_T4 = (RooRealVar *)datagaga->addColumn(wFuncgaga);
    datagaga -> Print();
    RooDataSet wdatagaga(datagaga->GetName(), datagaga->GetTitle(), datagaga, *datagaga->get(), 0, weight_T4->GetName());
    wdatagaga.Print();
  ...
  //RooKeysPdf bkgModel("bkgModel","KDE model",mrec,wdataHZ);
   ...
   frame->Draw();
   c1->Draw();
   c1->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/mumuH/plots/data.pdf");



   // S+ B fit in background region 
   RooRealVar N("N", "Extended term", nbkgMC_240GeV,25000,45000);
   ...
   r2->Print();
   RooPlot* frame2 = mrec.frame(Name("m_recoil_frame"), Title("Fit sidebands"), Bins(70));
   ...
   frame2->Draw();
   c2->Draw();
   c2->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/mumuH/plots/bkg_only.pdf");   
   ...
   RooRealVar sigma_240GeV("sigma", "sigma", 0.9, 0.01, 5.0);
   ...
   RooFitResult* r3 = model_240GeV.fitTo(wdataHZ, Range("FULL"),Save(), Extended(kTRUE), ExternalConstraints(RooArgSet(Lsmear_240GeV, Esmear_240GeV, COMsmear_240GeV, BRsmear_240GeV)));
   ...
   c3->Draw();
   c3->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/mumuH/plots/S_B_fit.pdf");
   ...
   params->printLatex(Sibling(*initParams), OutputFile("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/mumuH/plots/latextables.tex"));
   ...
   framecorr->Draw();
   ccorr->Draw();
   ccorr->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/mumuH/plots/corr.eps"); 
 ...
 c31->Draw();
 c31->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/mumuH/plots/pulls_resid.pdf");
 ...
 c->cd();
 c->Draw();
 c->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/mumuH/plots/Fit_pulls.pdf");
 ...
 w->import(wdataHZ);
 w->writeToFile("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/mumuH/ZmumuH240.root");
...
// C o n s t r u c t   p r o f i l e   l i k e l i h o o d   i n   m u  Z H
 ...
 frame6->Draw(); 
 c6->Draw(); 
 c6->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/mumuH/plots/NLL_prf_muZH.pdf");
 ...
 frame4->SetMinimum(-3.);
 frame4->SetMaximum(200.);
 frame4->Draw(); 
 c4->Draw(); 
 c4->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/mumuH/plots/NLL_prf_kl.pdf");
 ...
 */
 ...
 frame5->Draw();
 c5->Draw();
 c5->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/mumuH/plots/NLL_prf_mh.eps");
 */
 ...
 frame6->Draw();
 c6->Draw();
 c6->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/mumuH/plots/contour_kl_mH.pdf");
