...
void AZmumu_H() {
   ...
   //RooFitResult* r3 = model_240GeV.fitTo(wdataHZ,Save(), Extended(kTRUE), ExternalConstraints(RooArgSet(Lsmear_240GeV, Esmear_240GeV, COMsmear_240GeV)), Offset(kTRUE), NumCPU(8, 0), Minimizer("Minuit2","migrad"));
 ...
 w->pdf("model")->fitTo(*asimov,Save(), Extended(kTRUE), ExternalConstraints(RooArgSet(Lsmear_240GeV, Esmear_240GeV, COMsmear_240GeV)), Offset(kTRUE), NumCPU(8, 0), Minimizer("Minuit2","migrad"));
