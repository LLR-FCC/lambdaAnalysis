...
void Zcc_H() {
  ...
  // Import files
   ...
   TFile *qqFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/wzp6_ee_qqH_ecm240_sel_ccH_histo.root");
   TFile *WWFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/p8_ee_WW_ecm240_sel_ccH_histo.root");
   TFile *ZZFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/p8_ee_ZZ_ecm240_sel_ccH_histo.root");
   TFile *ZqqFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/p8_ee_Zqq_ecm240_sel_ccH_histo.root");
   ...
   RooRealVar mrec("MRec", "MRec [GeV]", 100, 160); //20, 160
   mrec.setConstant();
   ...
   mrec.setRange("FULL",100,160);    //120, 140 

   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    TFile *qqFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/ccH/source/wzp6_ee_qqH_ecm240_sel_ccH_noRVec.root");
    TFile *WWFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/ccH/source/p8_ee_WW_ecm240_sel_ccH_noRVec.root");
    TFile *ZZFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/ccH/source/p8_ee_ZZ_ecm240_sel_ccH_noRVec.root");
    TFile *ZqqFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/ccH/source/p8_ee_Zqq_ecm240_sel_ccH_noRVec.root");
   ...
   RooKeysPdf bkgModel("bkgModel","KDE model",mrec, wdataWW, RooKeysPdf::MirrorAsymBoth, 1.5);
   ...
   frame->Draw();
   c1->Draw();
   c1->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/ccH/aplots/data.pdf");
   ...
   RooFitResult* r2 = extmodel.fitTo(wdataWW, Range("FULL"),Save(), Offset(kTRUE), NumCPU(8, 0), Minimizer("Minuit2","migrad"));
   r2->Print();
   RooPlot* frame2 = mrec.frame(Name("m_recoil_frame"), Title("Fit background"), Bins(60));
   wdataWW.plotOn(frame2, DataError(RooAbsData::SumW2)); //SumW2
   ...
   frame2 -> GetXaxis()->SetRangeUser(100, 180);
   frame2->Draw();
   c2->Draw();
   c2->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/ccH/aplots/bkg_only.pdf");   
   ...
   RooConstVar Eideal_240GeV("Eideal_240GeV", "ideal Efficiency", 0.004929899); 
   ...
   RooRealVar mean_240GeV("mean", "mean", 120., 115., 150.);
   RooRealVar sigma_240GeV("sigma", "sigma", 2., 1., 10.);
   RooRealVar mean2_240GeV("mean2", "mean", 125., 120., 150.);
   RooRealVar sigma2_240GeV("sigma2", "sigma", 5., 0.1, 10.0);
   RooRealVar mean3_240GeV("mean3", "mean", 129., 120., 150.);
   RooRealVar sigma3_240GeV("sigma3", "sigma", 7., 1., 10.0);
   RooRealVar mean4_240GeV("mean4", "mean", 133., 125., 150.);
   ...
   //RooAddPdf sig_240GeV("finalsig", "final signal", RooArgList(gauss_240GeV, gauss2_240GeV, gauss3_240GeV), RooArgList(fsig, fsig2), true);
   RooAddPdf sig_240GeV("finalsig", "final signal", RooArgList(gauss_240GeV, gauss2_240GeV), RooArgList(fsig), true);
   ...
   RooFitResult* r3 = model_240GeV.fitTo(wdataHZ,Save(), Extended(kTRUE), ExternalConstraints(RooArgSet(Lsmear_240GeV, Esmear_240GeV, BRsmear_240GeV)), Offset(kTRUE), NumCPU(8, 0), Minimizer("Minuit2","migrad"), GlobalObservables(RooArgSet(Lmess_240GeV, Emess_240GeV, BRmess_240GeV)));
   
   r3->Print();

   
   RooPlot* frame3 = mrec.frame(Name("Mrecframe"), Title("S+B fit"), Bins(60));
   frame3 -> GetXaxis() ->SetRangeUser(100., 160); 
   ...
   c3->Draw();
   c3->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/ccH/aplots/S_B_fit.pdf");
   ...
   params->printLatex(Sibling(*initParams), OutputFile("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/ccH/aplots/latextables.tex"));
   ...
   cout << "S+B chi^2 = " << frame3 -> chiSquare(15) << endl;
   ...
   framecorr->Draw();
   ccorr->Draw();
   ccorr->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/ccH/aplots/corr.eps"); 
 ...
 // the name of the relevant curve and/or dataset in chiSquare()
  cout << "chi^2 = " << frame30 -> chiSquare(6) << endl;
 ...
 frame31 -> GetXaxis() ->SetRangeUser(100, 160);
 frame31->Draw();
 c31->cd(2);
 gPad->SetLeftMargin(0.15);
 frame32->GetYaxis()->SetTitleOffset(1.6);
 frame32 -> GetXaxis() ->SetRangeUser(100, 160);
 frame32->Draw();


 c31->Draw();
 c31->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/ccH/aplots/pulls_resid.pdf");
 ...
 c->cd();
 c->Draw();
 c->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/ccH/aplots/Fit_pulls.pdf");
 ...
 w->defineSet("np", RooArgSet(sigma_240GeV, sigma2_240GeV, sigma3_240GeV, mean2_240GeV, mean3_240GeV, fsig, fsig2, N, mean_240GeV), kTRUE);
 ...
 RooFitResult * r4 = w->pdf("model")->fitTo(*asimov,Save(), Extended(kTRUE), ExternalConstraints(RooArgSet(Lsmear_240GeV, Esmear_240GeV, BRsmear_240GeV)), Offset(kTRUE), NumCPU(8, 0), Minimizer("Minuit2","migrad"), GlobalObservables(RooArgSet(Lmess_240GeV, Emess_240GeV, BRmess_240GeV)), Strategy(2));
 ...
 r4->Print();
   ...
   frame7->Draw();
   c7->Draw();
   c7->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/ccH/aplots/adata.pdf");

  w->import(*asimov, Rename("ccH_Asimov"));

  RooArgSet *asimov_parameters = (RooArgSet*)w->pdf("model")->getParameters(mrec);
  w->saveSnapshot("ccH_asimovFit", *asimov_parameters, kTRUE);
  ...
  RooFitResult* r5 = modelBare_240GeV.fitTo(wdataHZ,Save(), Extended(kTRUE), Offset(kTRUE), NumCPU(8, 0), Minimizer("Minuit2","migrad"), Range("FIT"), Strategy(2));
  ...
  RooFitResult * r6 = w->pdf("modelBare")->fitTo(*asimov_bare,Save(), Extended(kTRUE), Offset(kTRUE), NumCPU(8, 0), Minimizer("Minuit2","migrad"), Range("FIT"), Strategy(2));

  std::cout << "Asimov designed for mu = 1 gave mu-hat = " << w->var("muZH_240GeV")->getVal() << std::endl;

  r6->Print();

  w->import(*asimov_bare, Rename("ccH_Asimov_bare"));

  RooArgSet *asimov_parameters_bare = (RooArgSet*)w->pdf("modelBare")->getParameters(mrec);
  w->saveSnapshot("ccH_asimovFit_bare", *asimov_parameters_bare, kTRUE);
  ...
  w->writeToFile("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/ccH/ZccH240_muZH.root");
...
// C o n s t r u c t   p r o f i l e   l i k e l i h o o d   i n   m u  Z H
 ...
 frame6->Draw(); 
 c6->Draw(); 
 c6->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/ccH/aplots/NLL_prf_muZH.pdf");
 ...
 */
 ...
 frame4->Draw(); 
 c4->Draw(); 
 c4->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/ccH/aplots/NLL_prf_kl.pdf");
...
*/
 ...
 frame5->Draw();
 c5->Draw();
 c5->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/ccH/aplots/NLL_prf_mh.eps");
 */
 ...
 // Save a snapshot of the fit result. This occect contains the initial
 ...
 frame6->Draw();
 c6->Draw();
 c6->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/ccH/aplots/contour_kl_mH.pdf");
