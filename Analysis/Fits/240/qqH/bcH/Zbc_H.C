...
void Zbc_H() {
  ...
  // Import files
   ...
   TFile *qqFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/wzp6_ee_qqH_ecm240_sel_bcH_histo.root");
   TFile *WWFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/p8_ee_WW_ecm240_sel_bcH_histo.root");
   TFile *ZZFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/p8_ee_ZZ_ecm240_sel_bcH_histo.root");
   TFile *ZqqFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/p8_ee_Zqq_ecm240_sel_bcH_histo.root");
   ...
   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    TFile *qqFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bcH/source/wzp6_ee_qqH_ecm240_sel_bcH_noRVec.root");
    TFile *WWFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bcH/source/p8_ee_WW_ecm240_sel_bcH_noRVec.root");
    TFile *ZZFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bcH/source/p8_ee_ZZ_ecm240_sel_bcH_noRVec.root");
    TFile *ZqqFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bcH/source/p8_ee_Zqq_ecm240_sel_bcH_noRVec.root");
   ...
   frame->Draw();
   c1->Draw();
   c1->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bcH/aplots/data.pdf");
   ...
   RooFitResult* r2 = extmodel.fitTo(wdataWW, Range("FULL"),Save(), Offset(kTRUE), NumCPU(8, 0), Minimizer("Minuit2","migrad"), PrefitDataFraction(0.1));
   r2->Print();
   ...
   frame2->Draw();
   c2->Draw();
   c2->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bcH/aplots/bkg_only.pdf");   
   ...
   RooConstVar Eideal_240GeV("Eideal_240GeV", "ideal Efficiency", 0.029663434);
   ...
   // Fit a sum of gaussian pdf to the data

   RooRealVar mean_240GeV("mean", "mean", 90., 80., 110.); //80., 30., 90.
   RooRealVar sigma_240GeV("sigma", "sigma", 20., 1., 40.);
   ...
   RooFitResult* r3 = model_240GeV.fitTo(wdataHZ,Save(), Extended(kTRUE), ExternalConstraints(RooArgSet(Lsmear_240GeV, Esmear_240GeV, BRsmear_240GeV)), Offset(kTRUE), NumCPU(8, 0), Minimizer("Minuit2","migrad"), PrefitDataFraction(0.1), GlobalObservables(RooArgSet(Lmess_240GeV, Emess_240GeV, BRmess_240GeV)));
   
   r3->Print();

   
   RooPlot* frame3 = mrec.frame(Name("Mrecframe"), Title("S+B fit"), Bins(60));
   frame3 -> GetXaxis() ->SetRangeUser(80., 160); 
   ...
   c3->Draw();
   c3->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bcH/aplots/S_B_fit.pdf");
   ...
   params->printLatex(Sibling(*initParams), OutputFile("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bcH/aplots/latextables.tex"));
   ...
   framecorr->Draw();
   ccorr->Draw();
   ccorr->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bcH/aplots/corr.eps"); 
 ...
 c31->Draw();
 c31->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bcH/aplots/pulls_resid.pdf");
 ...
 c->cd();
 c->Draw();
 c->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bcH/aplots/Fit_pulls.pdf");
 ...
 RooFitResult * r4 = w->pdf("model")->fitTo(*asimov,Save(), Extended(kTRUE), ExternalConstraints(RooArgSet(Lsmear_240GeV, Esmear_240GeV, BRsmear_240GeV)), Offset(kTRUE), NumCPU(8, 0), Minimizer("Minuit2","migrad"), PrefitDataFraction(0.1), GlobalObservables(RooArgSet(Lmess_240GeV, Emess_240GeV, BRmess_240GeV)));
 ...
 r4->Print();
   ...
   frame7->Draw();
   c7->Draw();
   c7->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bcH/aplots/adata.pdf");
  

  w->import(*asimov, Rename("bcH_Asimov"));

  RooArgSet *asimov_parameters = (RooArgSet*)w->pdf("model")->getParameters(mrec);
  w->saveSnapshot("bcH_asimovFit", *asimov_parameters, kTRUE);
  ...
  w->import(*asimov_bare, Rename("bcH_Asimov_bare"));

  RooArgSet *asimov_parameters_bare = (RooArgSet*)w->pdf("modelBare")->getParameters(mrec);
  w->saveSnapshot("bcH_asimovFit_bare", *asimov_parameters_bare, kTRUE);
  ...
  w->writeToFile("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bcH/ZbcH240_muZH.root");
...
// C o n s t r u c t   p r o f i l e   l i k e l i h o o d   i n   m u  Z H
 ...
 frame6->Draw(); 
 c6->Draw(); 
 c6->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bcH/aplots/NLL_prf_muZH.pdf");
 ...
 */
 ...
 frame4->Draw(); 
 c4->Draw(); 
 c4->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bcH/aplots/NLL_prf_kl.pdf");
...
*/
 ...
 frame5->Draw();
 c5->Draw();
 c5->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bcH/aplots/NLL_prf_mh.eps");
 */
 ...
 frame6->Draw();
 c6->Draw();
 c6->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bcH/aplots/contour_kl_mH.pdf");
