...
void Zbj_H() {
  ...
  // Import files
   ...
   TFile *qqFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/wzp6_ee_qqH_ecm240_sel_bjH_histo.root");
   TFile *WWFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/p8_ee_WW_ecm240_sel_bjH_histo.root");
   TFile *ZZFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/p8_ee_ZZ_ecm240_sel_bjH_histo.root");
   TFile *ZqqFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/p8_ee_Zqq_ecm240_sel_bjH_histo.root");
   ...
   RooRealVar mrec("MRec", "MRec [GeV]", 20, 160); //140 (fürs binning)
   mrec.setConstant();
   ...
   mrec.setRange("FULL",20,160);    //120, 140 

   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    TFile *qqFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bjH/source/wzp6_ee_qqH_ecm240_sel_bjH_noRVec.root");
    TFile *WWFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bjH/source/p8_ee_WW_ecm240_sel_bjH_noRVec.root");
    TFile *ZZFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bjH/source/p8_ee_ZZ_ecm240_sel_bjH_noRVec.root");
    TFile *ZqqFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bjH/source/p8_ee_Zqq_ecm240_sel_bjH_noRVec.root");
   ...
   RooKeysPdf bkgModel("bkgModel","KDE model",mrec, wdataWW, RooKeysPdf::MirrorAsymBoth, 2);
   ...
   frame->Draw();
   c1->Draw();
   c1->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bjH/aplots/data.pdf");
   ...
   frame2 -> GetXaxis()->SetRangeUser(20, 180);
   frame2->Draw();
   c2->Draw();
   c2->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bjH/aplots/bkg_only.pdf");   
   ...
   RooConstVar Eideal_240GeV("Eideal_240GeV", "ideal Efficiency", 0.10258);
   ...
   // Fit a sum of gaussians to the data

   RooRealVar mean_240GeV("mean", "mean", 80., 30., 90.);
   RooRealVar sigma_240GeV("sigma", "sigma", 20., 10., 40.);
   ...
   c3->Draw();
   c3->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bjH/aplots/S_B_fit.pdf");
   ...
   params->printLatex(Sibling(*initParams), OutputFile("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bjH/aplots/latextables.tex"));
   ...
   cout << "S+B chi^2 = " << frame3 -> chiSquare(13) << endl;
   ...
   framecorr->Draw();
   ccorr->Draw();
   ccorr->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bjH/aplots/corr.eps"); 
 ...
 c31->Draw();
 c31->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bjH/aplots/pulls_resid.pdf");
 ...
 c->cd();
 c->Draw();
 c->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bjH/aplots/Fit_pulls.pdf");
 ...
 r4->Print();
   ...
   frame7->Draw();
   c7->Draw();
   c7->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bjH/aplots/adata.pdf");

  w->import(*asimov, Rename("bjH_Asimov"));

  RooArgSet *asimov_parameters = (RooArgSet*)w->pdf("model")->getParameters(mrec);
  w->saveSnapshot("bjH_asimovFit", *asimov_parameters, kTRUE);
  ...
  w->import(*asimov_bare, Rename("bjH_Asimov_bare"));

  RooArgSet *asimov_parameters_bare = (RooArgSet*)w->pdf("modelBare")->getParameters(mrec);
  w->saveSnapshot("bjH_asimovFit_bare", *asimov_parameters_bare, kTRUE);
  ...
  w->writeToFile("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bjH/ZbjH240_muZH.root");
...
// C o n s t r u c t   p r o f i l e   l i k e l i h o o d   i n   m u  Z H
 ...
 frame6->Draw(); 
 c6->Draw(); 
 c6->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bjH/aplots/NLL_prf_muZH.pdf");
 ...
 */
 ...
 frame4->Draw(); 
 c4->Draw(); 
 c4->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bjH/aplots/NLL_prf_kl.pdf");
...
*/
 ...
 frame5->Draw();
 c5->Draw();
 c5->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bjH/aplots/NLL_prf_mh.eps");
 */
 ...
 frame6->Draw();
 c6->Draw();
 c6->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/bjH/aplots/contour_kl_mH.pdf");
