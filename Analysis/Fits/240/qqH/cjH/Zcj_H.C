...
void Zcj_H() {
  ...
  // Import files
   ...
   TFile *qqFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/wzp6_ee_qqH_ecm240_sel_cjH_histo.root");
   TFile *WWFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/p8_ee_WW_ecm240_sel_cjH_histo.root");
   TFile *ZZFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/p8_ee_ZZ_ecm240_sel_cjH_histo.root");
   TFile *ZqqFile = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/histos/p8_ee_Zqq_ecm240_sel_cjH_histo.root");
   ...
   RooRealVar mrec("MRec", "MRec [GeV]", 90, 160); //140 (fürs binning)
   mrec.setConstant();
   ...
   mrec.setRange("FULL",90,160);    //120, 140 

   ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    TFile *qqFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/cjH/source/wzp6_ee_qqH_ecm240_sel_cjH_noRVec.root");
    TFile *WWFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/cjH/source/p8_ee_WW_ecm240_sel_cjH_noRVec.root");
    TFile *ZZFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/cjH/source/p8_ee_ZZ_ecm240_sel_cjH_noRVec.root");
    TFile *ZqqFileT = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/cjH/source/p8_ee_Zqq_ecm240_sel_cjH_noRVec.root");
   ...
   RooKeysPdf bkgModel("bkgModel","KDE model",mrec, wdataWW, RooKeysPdf::MirrorAsymBoth, 2.25);
   ...
   frame->Draw();
   c1->Draw();
   c1->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/cjH/aplots/data.pdf");
   ...
   frame2 -> GetXaxis()->SetRangeUser(90, 160);
   frame2->Draw();
   c2->Draw();
   c2->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/cjH/aplots/bkg_only.pdf");   
   ...
   RooConstVar Eideal_240GeV("Eideal_240GeV", "ideal Efficiency", 0.026376869); 
   ...
   RooRealVar mean_240GeV("mean", "mean", 120., 90., 140.);
   RooRealVar sigma_240GeV("sigma", "sigma", 10., 3., 40.);
   RooRealVar mean2_240GeV("mean2", "mean", 115., 90., 120.);
   RooRealVar sigma2_240GeV("sigma2", "sigma", 12., 2, 30.0);
   RooRealVar mean3_240GeV("mean3", "mean", 130., 120., 150.);
   RooRealVar sigma3_240GeV("sigma3", "sigma", 7., 1., 10.0);
   RooRealVar mean4_240GeV("mean4", "mean", 139., 120., 160.);
   RooRealVar sigma4_240GeV("sigma4", "sigma", 3.7, 1., 30.0);
   ...
   frame3 -> GetXaxis() ->SetRangeUser(90., 160); 
   ...
   c3->Draw();
   c3->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/cjH/aplots/S_B_fit.pdf");

   RooPlot* frame99 = mrec.frame(Name("MrecframeForChiSquared"), Title("S+B fit"), Bins(60));
   frame99 -> GetXaxis() ->SetRangeUser(90., 160); 
   wdataHZ.plotOn(frame99,DataError(RooAbsData::SumW2), Bins(60));
   model_240GeV.plotOn(frame99, LineColor(kAzure-2), Bins(60)); 
   ...
   params->printLatex(Sibling(*initParams), OutputFile("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/cjH/aplots/latextables.tex"));
   ...
   cout << "S+B chi^2 = " << frame30 -> chiSquare(15) << endl;
   ...
   framecorr->Draw();
   ccorr->Draw();
   ccorr->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/cjH/aplots/corr.eps"); 
 ...
 // the name of the relevant curve and/or dataset in chiSquare()
  cout << "chi^2 = " << frame30 -> chiSquare(12) << endl;
 ...
 frame31 -> GetXaxis() ->SetRangeUser(90, 160);
 frame31->Draw();
 c31->cd(2);
 gPad->SetLeftMargin(0.15);
 frame32->GetYaxis()->SetTitleOffset(1.6);
 frame32 -> GetXaxis() ->SetRangeUser(90, 160);
 frame32->Draw();


 c31->Draw();
 c31->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/cjH/aplots/pulls_resid.pdf");
 ...
 c->cd();
 c->Draw();
 c->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/cjH/aplots/Fit_pulls.pdf");
 ...
 RooFitResult * r4 = w->pdf("model")->fitTo(*asimov,Save(), Extended(kTRUE), ExternalConstraints(RooArgSet(Lsmear_240GeV, Esmear_240GeV, BRsmear_240GeV)), Offset(kTRUE), NumCPU(8, 0), Minimizer("Minuit2","migrad"), GlobalObservables(RooArgSet(Lmess_240GeV, Emess_240GeV, BRmess_240GeV)));
 ...
 r4->Print();
   ...
   frame7->Draw();
   c7->Draw();
   c7->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/cjH/aplots/adata.pdf");

  w->import(*asimov, Rename("cjH_Asimov"));

  RooArgSet *asimov_parameters = (RooArgSet*)w->pdf("model")->getParameters(mrec);
  w->saveSnapshot("cjH_asimovFit", *asimov_parameters, kTRUE);
  ...
  w->import(*asimov_bare, Rename("cjH_Asimov_bare"));

  RooArgSet *asimov_parameters_bare = (RooArgSet*)w->pdf("modelBare")->getParameters(mrec);
  w->saveSnapshot("cjH_asimovFit_bare", *asimov_parameters_bare, kTRUE);
  ...
  w->writeToFile("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/cjH/ZcjH240_muZH.root");
...
// C o n s t r u c t   p r o f i l e   l i k e l i h o o d   i n   m u  Z H
 ...
 frame6->Draw(); 
 c6->Draw(); 
 c6->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/cjH/aplots/NLL_prf_muZH.pdf");
 ...
 */
 ...
 frame4->Draw(); 
 c4->Draw(); 
 c4->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/cjH/aplots/NLL_prf_kl.pdf");
...
*/
 ...
 frame5->Draw();
 c5->Draw();
 c5->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/cjH/aplots/NLL_prf_mh.eps");
 */
 ...
 frame6->Draw();
 c6->Draw();
 c6->SaveAs("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/Fits/240/qqH/cjH/aplots/contour_kl_mH.pdf");
