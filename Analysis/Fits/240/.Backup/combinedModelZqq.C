...
//wcombData->Print();
    ...
    RooFitResult * r =  combModel -> fitTo(*acombData,Save(), Extended(kTRUE), ExternalConstraints(smearSet), Offset(kTRUE), NumCPU(8, 0), Minimizer("Minuit2","migrad"), GlobalObservables(globSet));  //SumW2Error(kTRUE)
