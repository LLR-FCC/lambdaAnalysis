...
void combinedModel240() {
    ...
    RooAbsPdf * bareModel_bbH = bbH_WS->pdf("modelBare");
    RooAbsPdf * bareModel_bcH = bcH_WS->pdf("modelBare");
    RooAbsPdf * bareModel_bjH = bjH_WS->pdf("modelBare");
    RooAbsPdf * bareModel_ccH = ccH_WS->pdf("modelBare");
    RooAbsPdf * bareModel_cjH = cjH_WS->pdf("modelBare");
    RooAbsPdf * bareModel_ijH = ijH_WS->pdf("modelBare");
    ...
    combWS->import(*bareModel_bbH, RenameAllNodes("bbH"), RenameAllVariables("bbH"));
    combWS->import(*bareModel_bcH, RenameAllNodes("bcH"), RenameAllVariables("bcH"));
    combWS->import(*bareModel_bjH, RenameAllNodes("bjH"), RenameAllVariables("bjH"));
    combWS->import(*bareModel_ccH, RenameAllNodes("ccH"), RenameAllVariables("ccH"));
    combWS->import(*bareModel_cjH, RenameAllNodes("cjH"), RenameAllVariables("cjH"));
    combWS->import(*bareModel_ijH, RenameAllNodes("ijH"), RenameAllVariables("ijH"));
...
//wcombData->Print();
    ...
    combWS->factory("SIMUL::joint(channel,bbH=model_bbH,bcH=model_bcH, bjH=model_bjH, ccH=model_ccH, cjH=model_cjH, ijH=model_ijH, mumuH=model_mumuH, eeH=model_eeH)") ;
    combWS->factory("SIMUL::joint_bare(channel,bbH=modelBare_bbH,bcH=modelBare_bcH, bjH=modelBare_bjH, ccH=modelBare_ccH, cjH=modelBare_cjH, ijH=modelBare_ijH, mumuH=modelBare_mumuH, eeH=modelBare_eeH)") ;
    combWS->factory("SIMUL::joint_hadr(channel,bbH=model_bbH,bcH=model_bcH, bjH=model_bjH, ccH=model_ccH, cjH=model_cjH, ijH=model_ijH)") ;
    ...
    combWS -> factory("EDIT::combModel(joint, MRec_bbH = MRec, MRec_bcH = MRec, MRec_bjH = MRec, MRec_ccH = MRec, MRec_cjH = MRec, MRec_ijH = MRec, MRec_mumuH = MRec, MRec_eeH = MRec, muZH_240GeV_bbH = muZH_240GeV, muZH_240GeV_bcH = muZH_240GeV, muZH_240GeV_bjH = muZH_240GeV, muZH_240GeV_ccH = muZH_240GeV, muZH_240GeV_cjH = muZH_240GeV, muZH_240GeV_ijH = muZH_240GeV, muZH_240GeV_mumuH = muZH_240GeV, muZH_240GeV_eeH = muZH_240GeV, mHmess_240GeV_mumuH=mHmess_240GeV, mHmess_240GeV_eeH=mHmess_240GeV)");

    combWS -> factory("EDIT::combModel_bare(joint_bare, MRec_bbH = MRec, MRec_bcH = MRec, MRec_bjH = MRec, MRec_ccH = MRec, MRec_cjH = MRec, MRec_ijH = MRec, MRec_mumuH = MRec, MRec_eeH = MRec, muZH_240GeV_bbH = muZH_240GeV, muZH_240GeV_bcH = muZH_240GeV, muZH_240GeV_bjH = muZH_240GeV, muZH_240GeV_ccH = muZH_240GeV, muZH_240GeV_cjH = muZH_240GeV, muZH_240GeV_ijH = muZH_240GeV, muZH_240GeV_mumuH = muZH_240GeV, muZH_240GeV_eeH = muZH_240GeV, mHmess_240GeV_mumuH=mHmess_240GeV, mHmess_240GeV_eeH=mHmess_240GeV)");

    combWS -> factory("EDIT::combModel_hadr(joint_hadr, MRec_bbH = MRec, MRec_bcH = MRec, MRec_bjH = MRec, MRec_ccH = MRec, MRec_cjH = MRec, MRec_ijH = MRec, muZH_240GeV_bbH = muZH_240GeV, muZH_240GeV_bcH = muZH_240GeV, muZH_240GeV_bjH = muZH_240GeV, muZH_240GeV_ccH = muZH_240GeV, muZH_240GeV_cjH = muZH_240GeV, muZH_240GeV_ijH = muZH_240GeV)");
    ...
    RooAbsPdf* combModel_hadr = combWS->pdf("combModel_hadr");
    ...
    RooArgSet globSet_hadr = *(combWS->set("glob_hadr"));
    RooArgSet nuisSet_hadr = *(combWS->set("np_hadr"));
    RooArgSet smearSet_hadr = *(combWS->set("constr_hadr"));
  ...
  */
  ...
  //mcb.SetGlobalObservables(globSet);
  //mcb.SetConstraintParameters(globSet);
  ...
  RooCmdArg cmdList3;
    ...
    RooFitResult * rB = combModel_bare -> fitTo(*acombData, linkedCmdList2);

    (combWS->var("BRmess_240GeV_bcH"))->setVal(1);
    (combWS->var("BRmess_240GeV_bbH"))->setVal(1);
    (combWS->var("BRmess_240GeV_bjH"))->setVal(1);
    (combWS->var("BRmess_240GeV_ccH"))->setVal(1);
    (combWS->var("BRmess_240GeV_cjH"))->setVal(1);
    (combWS->var("BRmess_240GeV_ijH"))->setVal(1);
    (combWS->var("BRmess_240GeV_mumuH"))->setVal(1);
    (combWS->var("BRmess_240GeV_eeH"))->setVal(1);
    
    (combWS->var("Emess_240GeV_bcH"))->setVal(1);
    (combWS->var("Emess_240GeV_bbH"))->setVal(1);
    (combWS->var("Emess_240GeV_bjH"))->setVal(1);
    (combWS->var("Emess_240GeV_ccH"))->setVal(1);
    (combWS->var("Emess_240GeV_cjH"))->setVal(1);
    (combWS->var("Emess_240GeV_ijH"))->setVal(1);
    (combWS->var("Emess_240GeV_mumuH"))->setVal(1);
    (combWS->var("Emess_240GeV_eeH"))->setVal(1);

    (combWS->var("Lmess_240GeV_bcH"))->setVal(1);
    (combWS->var("Lmess_240GeV_bbH"))->setVal(1);
    (combWS->var("Lmess_240GeV_bjH"))->setVal(1);
    (combWS->var("Lmess_240GeV_ccH"))->setVal(1);
    (combWS->var("Lmess_240GeV_cjH"))->setVal(1);
    (combWS->var("Lmess_240GeV_ijH"))->setVal(1);
    ...
    (combWS->var("BRmess_240GeV_bcH"))->setConstant(kTRUE);
    (combWS->var("BRmess_240GeV_bbH"))->setConstant(kTRUE);
    (combWS->var("BRmess_240GeV_bjH"))->setConstant(kTRUE);
    (combWS->var("BRmess_240GeV_ccH"))->setConstant(kTRUE);
    (combWS->var("BRmess_240GeV_cjH"))->setConstant(kTRUE);
    (combWS->var("BRmess_240GeV_ijH"))->setConstant(kTRUE);
    (combWS->var("BRmess_240GeV_mumuH"))->setConstant(kTRUE);
    (combWS->var("BRmess_240GeV_eeH"))->setConstant(kTRUE);
    
    (combWS->var("Emess_240GeV_bcH"))->setConstant(kTRUE);
    (combWS->var("Emess_240GeV_bbH"))->setConstant(kTRUE);
    (combWS->var("Emess_240GeV_bjH"))->setConstant(kTRUE);
    (combWS->var("Emess_240GeV_ccH"))->setConstant(kTRUE);
    (combWS->var("Emess_240GeV_cjH"))->setConstant(kTRUE);
    (combWS->var("Emess_240GeV_ijH"))->setConstant(kTRUE);
    (combWS->var("Emess_240GeV_mumuH"))->setConstant(kTRUE);
    (combWS->var("Emess_240GeV_eeH"))->setConstant(kTRUE);

    (combWS->var("Lmess_240GeV_bcH"))->setConstant(kTRUE);
    (combWS->var("Lmess_240GeV_bbH"))->setConstant(kTRUE);
    (combWS->var("Lmess_240GeV_bjH"))->setConstant(kTRUE);
    (combWS->var("Lmess_240GeV_ccH"))->setConstant(kTRUE);
    (combWS->var("Lmess_240GeV_cjH"))->setConstant(kTRUE);
    (combWS->var("Lmess_240GeV_ijH"))->setConstant(kTRUE);
  ...
  RooAbsData * asimov_bare = RooStats::AsymptoticCalculator::MakeAsimovData(mcb, combSet, genObs);

  RooFitResult * rB2 = combModel_bare->fitTo(*asimov_bare, linkedCmdList3);



  combWS->import(*asimov_bare, Rename("combined_Asimov_bare"));

  RooArgSet *asimov_parameters_bare = (RooArgSet*)combModel_bare->getParameters(*mrec);
  combWS->saveSnapshot("asimovFit_bare", *asimov_parameters_bare, kTRUE);

  r98->Print();
  rB2->Print();
  asimov_parameters->Print("V");
  asimov_parameters_bare->Print("V");
