...
outdir="/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_nunuH_inclusive/240/presel/"

import multiprocessing
NUM_CPUS = int(multiprocessing.cpu_count()-2)

process_list=['wzp6_ee_nunuH_ecm240','p8_ee_WW_ecm240','p8_ee_ZZ_ecm240','p8_ee_Zll_ecm240']
fraction=1.0
