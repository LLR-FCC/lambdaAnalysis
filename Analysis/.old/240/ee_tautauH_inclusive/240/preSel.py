...
outdir="/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_tautauH_inclusive/240/presel/"

import multiprocessing
NUM_CPUS = int(multiprocessing.cpu_count()-2)

process_list=['wzp6_ee_tautauH_ecm240','p8_ee_WW_ecm240','p8_ee_ZZ_ecm240','p8_ee_Zll_ecm240', 'wzp6_gaga_tautau_60_ecm240']
fraction=0.1
