...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   inputS_qqH = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/presel_float/wzp6_ee_qqH_ecm240.root", "UPDATE");
   inputB_Zqq = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/presel_float/p8_ee_Zqq_ecm240.root", "UPDATE");
   inputB_ZZ = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/presel_float/p8_ee_ZZ_ecm240.root", "UPDATE");
   inputB_WW = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/ee_bbH_inclusive/240/presel_float/p8_ee_WW_ecm240.root", "UPDATE");
   ...
   auto _b_classifier_BDT = theTree->Branch("FinalClassifier_BDT", &_FinalClassifier_BDT, "FinalClassifier_BDT/F");
   ...
   TFile *target  = new TFile( "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/TMVA/Test/bbH/output/TMVApp.root","RECREATE" );
