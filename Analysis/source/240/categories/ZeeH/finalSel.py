...
#process_list=['p8_ee_ZZ_ecm240','p8_ee_WW_ecm240','p8_ee_Zll_ecm240']
process_list=['wzp6_ee_mumu_ecm240']
...
cut_list = {
            "sel_ZeeH":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && zed_leptonicE_m.size() == 1 && zed_leptonicE_charge[0] == 0",
            "sel_ZeeH1":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && zed_leptonicE_m.size() == 1 && zed_leptonicE_m[0] > 86 &&  zed_leptonicE_m[0] < 96 && zed_leptonicE_charge[0] == 0",
            "sel_ZeeH2":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && zed_leptonicE_m.size() == 1 && zed_leptonicE_m[0] > 86 &&  zed_leptonicE_m[0] < 96 && zed_leptonicE_recoil_m[0] > 120 && zed_leptonicE_recoil_m[0] < 140 && zed_leptonicE_charge[0] == 0",
            "sel_ZeeH3":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && zed_leptonicE_m.size() == 1 && zed_leptonicE_m[0] > 86 &&  zed_leptonicE_m[0] < 96 && zed_leptonicE_recoil_m[0] > 120 && zed_leptonicE_recoil_m[0] < 140 && zed_leptonicE_pt[0] > 20 && zed_leptonicE_pt[0] < 70 && zed_leptonicE_charge[0] == 0",
            "sel_ZeeH4":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && zed_leptonicE_m.size() == 1 && zed_leptonicE_m[0] > 86 &&  zed_leptonicE_m[0] < 96 && zed_leptonicE_recoil_m[0] > 120 && zed_leptonicE_recoil_m[0] < 140 && zed_leptonicE_pt[0] > 20 && zed_leptonicE_pt[0] < 70 && missingET_costheta.size() ==1 && missingET_costheta[0] > -0.98 && missingET_costheta[0] < 0.98 && zed_leptonicE_charge[0] == 0",
            "sel_ZeeH5":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && zed_leptonicE_m.size() == 1 && zed_leptonicE_m[0] > 86 &&  zed_leptonicE_m[0] < 96 && zed_leptonicE_recoil_m[0] > 122 && zed_leptonicE_recoil_m[0] < 135 && zed_leptonicE_pt[0] > 20 && zed_leptonicE_pt[0] < 70 && missingET_costheta.size() ==1 && missingET_costheta[0] > -0.98 && missingET_costheta[0] < 0.98 && zed_leptonicE_charge[0] == 0"
...
variables = {
    ...
    "leptonic_recoil_m_zoom6":{"name":"zed_leptonicE_recoil_m","title":"M_{Rec} [GeV]","bin":70,"xmin":120,"xmax":140},
