...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   reader->AddVariable( "zed_hadronic_subjets_ctag[0]", &zzed_cjet1 );
   reader->AddVariable( "zed_hadronic_subjets_ctag[1]", &zzed_cjet2 );
   ...
   TString dir    = "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/categories/ZqqH/TMVA/cjH/dataset/weights/";
   ...
   //inputS_qqH = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/wzp6_ee_qqH_ecm240.root", "UPDATE");
   //inputB_Zqq = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/p8_ee_Zqq_ecm240.root", "UPDATE");
   //inputB_ZZ = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/p8_ee_ZZ_ecm240.root", "UPDATE");
   inputB_WW = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/presel/p8_ee_WW_ecm240.root", "UPDATE");
   ...
   theTree->SetBranchAddress("zed_hadronic_subjets_ctag", &zed_hadronic_subjets_ctag);
   ...
   TFile *target  = new TFile( "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/categories/ZqqH/TMVA/cjH/output/TMVApp_WW.root","RECREATE" );
