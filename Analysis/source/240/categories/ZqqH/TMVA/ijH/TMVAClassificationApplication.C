...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   TString dir    = "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/categories/ZqqH/TMVA/ijH/dataset/weights/";
   ...
   float _FinalClassifier_BDT_ij;
   //float _FinalClassifier_DNN;
   //float _FinalClassifier_MLP;

   auto _b_classifier_BDT_ij = theTree->Branch("_FinalClassifier_BDT_ij", &_FinalClassifier_BDT_ij, "_FinalClassifier_BDT_ij/F");
   ...
   TFile *target  = new TFile( "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/categories/ZqqH/TMVA/ijH/output/TMVApp_WW.root","RECREATE" );
