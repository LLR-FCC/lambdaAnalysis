...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   TString dir    = "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/categories/ZqqH/TMVA/bjH/dataset/weights/";
   ...
   float _FinalClassifier_BDT_bj;
   //float _FinalClassifier_DNN;
   //float _FinalClassifier_MLP;

   auto _b_classifier_BDT_bj = theTree->Branch("_FinalClassifier_BDT_bj", &_FinalClassifier_BDT_bj, "_FinalClassifier_BDT_bj/F");
   ...
   TFile *target  = new TFile( "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/categories/ZqqH/TMVA/bjH/output/TMVApp_WW.root","RECREATE" );
