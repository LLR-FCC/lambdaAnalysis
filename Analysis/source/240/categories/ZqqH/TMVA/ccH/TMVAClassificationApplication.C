...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   TString dir    = "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/categories/ZqqH/TMVA/ccH/dataset/weights/";
   ...
   float _FinalClassifier_BDT_cc;
   //float _FinalClassifier_DNN;
   //float _FinalClassifier_MLP;

   auto _b_classifier_BDT_cc = theTree->Branch("_FinalClassifier_BDT_cc", &_FinalClassifier_BDT_cc, "_FinalClassifier_BDT_cc/F");
   ...
   TFile *target  = new TFile( "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/categories/ZqqH/TMVA/ccH/output/TMVApp_ZZ.root","RECREATE" );
