...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   TString dir    = "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/categories/ZqqH/TMVA/bcH/dataset/weights/";
   ...
   float _FinalClassifier_BDT_bc;
   //float _FinalClassifier_DNN;
   //float _FinalClassifier_MLP;

   auto _b_classifier_BDT_bc = theTree->Branch("_FinalClassifier_BDT_bc", &_FinalClassifier_BDT_bc, "_FinalClassifier_BDT_bc/F");
   ...
   TFile *target  = new TFile( "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/categories/ZqqH/TMVA/bcH/output/TMVApp_WW.root","RECREATE" );
