...
energy         = 240.0
collider       = 'FCC-ee'
inputDir       = '/eos/user/n/niharrin/llr/presel/240/qqH/'
formats        = ['png']
yaxis          = ['lin','log']
stacksig       = ['stack','nostack']
outdir         = '/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/240/categories/ZqqH/plots/'
scaleSig       = 1.0
#ana_tex    = 'M_{Rec} \in [100, 160] GeV, M_{ij} \in [86, 96] GeV'
ana_tex        = ''

#variables = ['m_rec2', 'FinalClassifier_BDT_bc']
...
variables = ['m_rec', 'm_rec2', 'jet_ht', 'htheta', 'hrtheta', 'pT1', 'pT2', 'E1', 'E2', 'Eta1', 'Eta2', 'Acoll_ij', 'Acoll_PaPb', 'DeltaEta_ij', 'DeltaPhi_ij', 'Jet_No', 'bJet_No', 'cJet_No', 'pT_ij', 'M_ij', 'MET', 'MET_Angle', 'pL_ij', 'pL1', 'pL2', 'FinalClassifier_BDT_bb', 'FinalClassifier_BDT_bc', 'FinalClassifier_BDT_bj', 'FinalClassifier_BDT_cj', 'FinalClassifier_BDT_ij', 'FinalClassifier_BDT_cc']
...
selections['ZH']   = ["sel_noBDT_bbH", "sel_noBDT_bcH", "sel_noBDT_ccH", "sel_noBDT_cjH", "sel_noBDT_bjH", "sel_noBDT_ijH", "sel_bbH", "sel_bcH", "sel_bjH", "sel_ccH", "sel_cjH", "sel_ijH"]
...
extralabel['sel_bbH'] = "sel_noBDT_bbH cut, #beta_{bb} > 0.1535"
...
extralabel['sel_bcH'] = "sel_noBDT_bcH cuts, #beta_{bc} > 0.1836"
...
extralabel['sel_ccH'] = "sel_noBDT_ccH cuts, #beta_{cc} > 0.3920"
...
extralabel['sel_cjH'] = "sel_noBDT_cjH cuts, #beta_{cj} > 0.3074"
...
extralabel['sel_bjH'] = "sel_noBDT_bjH cut, #beta_{bj} > 0.2211"
extralabel['sel_bjH1'] = "sel_noBDT_bjH cut, Acoll_{ij} < 2, #beta_{bj} > 0.2211"
extralabel['sel_bjH2'] = "sel_noBDT_bjH cut, Acoll_{ij} < 2, #beta_{bj} > 0.2211"

extralabel['sel_noBDT_ijH'] = "2e, 2#mu veto, Z#rightarrow ij, M_{ij} #in #[]{86, 96} GeV, M_{Rec} #in #[]{100, 160} GeV"
extralabel['sel_ijH'] = "sel_noBDT_ijH cut, #beta_{ij} > 0.3710"
