...
void TMVAClassificationApplication( TString myMethodList = "" )
{
   ...
   float zzed_hadronic_subjets_DeltaPhi= 0.;
   float zzed_hadronic_subjets_DeltaEta= 0.;
   ...
   reader->AddVariable( "zed_hadronic_subjets_btag[0]", &zzed_cjet1 );
   reader->AddVariable( "zed_hadronic_subjets_btag[1]", &zzed_cjet2 );
   ...
   reader->AddVariable( "zed_hadronic_subjets_DeltaEta[0]", &zzed_hadronic_subjets_DeltaEta );
   reader->AddVariable( "zed_hadronic_subjets_DeltaPhi[0]", &zzed_hadronic_subjets_DeltaPhi );
   ...
   TString dir    = "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/365/categories/ZqqH/TMVA/cjH/dataset/weights/";
   ...
   inputS_qqH = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/365/presel/wzp6_ee_qqH_ecm365.root", "UPDATE");
   inputB_Zqq = TFile::Open("/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/365/presel/p8_ee_Zqq_ecm365.root", "UPDATE");
   ...
   theTree->SetBranchStatus("zed_hadronic_subjets_DeltaEta", 1);
   theTree->SetBranchStatus("zed_hadronic_subjets_DeltaPhi", 1);
   ...
   std::vector<float> *zed_hadronic_subjets_ctag = 0;
   ...
   std::vector<float> *zed_hadronic_subjets_DeltaEta = 0;
   std::vector<float> *zed_hadronic_subjets_DeltaPhi = 0;
   ...
   theTree->SetBranchAddress("zed_hadronic_subjets_btag", &zed_hadronic_subjets_ctag);
   ...
   theTree->SetBranchAddress( "zed_hadronic_subjets_DeltaEta", &zed_hadronic_subjets_DeltaEta );
   theTree->SetBranchAddress( "zed_hadronic_subjets_DeltaPhi", &zed_hadronic_subjets_DeltaPhi );
   ...
   float _FinalClassifier_BDT_cj;
   //float _FinalClassifier_DNN;
   //float _FinalClassifier_MLP;

   auto _b_classifier_BDT_cj = theTree->Branch("_FinalClassifier_BDT_cj", &_FinalClassifier_BDT_cj, "_FinalClassifier_BDT_cj/F");
   ...
   for (Long64_t ievt=0; ievt<nentries;ievt++) {
      ...
      zzed_cjet1 = ((zed_hadronic_subjets_ctag && (zed_hadronic_subjets_ctag->size() > 0)) ? (*zed_hadronic_subjets_ctag)[0] : 0);
      zzed_cjet2 = ((zed_hadronic_subjets_ctag && (zed_hadronic_subjets_ctag->size() > 0)) ? (*zed_hadronic_subjets_ctag)[1] : 0);
      ...
      zzed_hadronic_subjets_DeltaEta = ((zed_hadronic_subjets_DeltaEta && (zed_hadronic_subjets_DeltaEta->size() > 0)) ? (*zed_hadronic_subjets_DeltaEta)[0] : 0);
      zzed_hadronic_subjets_DeltaPhi = ((zed_hadronic_subjets_DeltaPhi && (zed_hadronic_subjets_DeltaPhi->size() > 0)) ? (*zed_hadronic_subjets_DeltaPhi)[0] : 0);
   ...
   TFile *target  = new TFile( "/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/365/categories/ZqqH/TMVA/cjH/output/TMVApp_WW.root","RECREATE" );
