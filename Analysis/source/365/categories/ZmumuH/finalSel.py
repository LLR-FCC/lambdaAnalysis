...
process_list=['wzp6_ee_mumuH_ecm365','p8_ee_ZZ_ecm365','p8_ee_WW_ecm365','wzp6_gaga_mumu_60_ecm365', 'wzp6_ee_mumu_ecm365', 'wzp6_ee_tautau_ecm365']
...
cut_list = {
            ...
            "sel_ZmumuH4":"!(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && (!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && zed_leptonicM_m.size() == 1 && zed_leptonicM_m[0] > 86 &&  zed_leptonicM_m[0] < 96 && zed_leptonicM_recoil_m[0] > 120 && zed_leptonicM_recoil_m[0] < 140 && zed_leptonicM_pt[0] > 70 && zed_leptonicM_charge[0] == 0",
            #"sel_ZmumuH5":"!(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && (!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && zed_leptonicM_m.size() == 1 && zed_leptonicM_m[0] > 86 &&  zed_leptonicM_m[0] < 96 && zed_leptonicM_recoil_m[0] > 120 && zed_leptonicM_recoil_m[0] < 140 && zed_leptonicM_pt[0] > 80 && zed_leptonicM_charge[0] == 0",
