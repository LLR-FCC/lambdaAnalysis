...
outdir         = '/afs/cern.ch/user/n/niharrin/work/public/MA/Analysis/source/365/categories/eeHbb/plots/'
scaleSig       = 1.0
...
variables = ['m_rec', 'jet_ht', 'htheta', 'hrtheta', 'pT1', 'pT2', 'E1', 'E2', 'Eta1', 'Eta2', 'Acoll_ij', 'Acoll_PaPb', 'Jet_No', 'bJet_No', 'pT_ij', 'M_ij', 'MET', 'MET_Angle', 'pL_ij', 'pL1', 'pL2', 'DeltaEta_ij', 'cJet_No', 'M_H', 'FinalClassifier_BDT_ee']
...
selections['VBF']   = ["sel_noBDT_eeHbb", "sel_noBDT_eeH", "sel_eeHbb", "sel_eeH"]
#selections['VBF']   = ["sel_noBDT_eeHbb", "sel_noBDT_eeH"]
...
extralabel['sel_noBDT_eeHbb'] = "N_{bH} = 2, #||{#Delta #eta} < 3, HT > 20 GeV, No e or #mu in FS"
extralabel['sel_noBDT_eeH'] = "Inclusive H decay"

extralabel['sel_eeHbb'] = "N_{bH} = 2, #||{#Delta #eta} < 3, HT > 20 GeV, No e or #mu in FS, #beta_{ee} > -0.1034"
extralabel['sel_eeH'] = "Inclusive H decay, #beta_{ee} > -0.1034"
