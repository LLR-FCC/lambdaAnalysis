...
#process_list=['p8_ee_WW_ecm365','p8_ee_ZZ_ecm365', 'wzp6_ee_ee_Mee_30_150_ecm365']
...
cut_list = {
            ...
            #"sel_noBDT_eeHbb":"n_eminus == 1 && n_eplus == 1 && mass_ee > 110 && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20",

            #"sel_noBDT_eeH":"n_eminus == 1 && n_eplus == 1 && mass_ee > 110 && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6)",

            #"sel_eeHbb":"n_eminus == 1 && n_eplus == 1 && mass_ee > 110 && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && _FinalClassifier_BDT_ee > -0.1034",

            #"sel_eeH":"n_eminus == 1 && n_eplus == 1 && mass_ee > 110 && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && _FinalClassifier_BDT_ee > -0.1034",

            
            
            
            #"sel1":"n_eminus == 1 && n_eplus == 1 && mass_ee > 110 && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2)",

            #"sel2":"selected_electrons_pt.size() == 2",

            #Separiere mit MC die contributions aus den samples und dann selektiere nochmal mit den reco electrons (Categorization)



            #"selVBF_noBDT_VetoM1":"n_eminus == 1 && n_eplus == 1 && mass_ee > 110 && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25",

            #"selVBF_noBDT_VetoM2":"n_eminus == 1 && n_eplus == 1 && mass_ee > 110 && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100",

            #"selVBF_noBDT_VetoM3":"n_eminus == 1 && n_eplus == 1 && mass_ee > 110 && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90",

            #"selVBF_noBDT_VetoM4":"n_eminus == 1 && n_eplus == 1 && mass_ee > 110 && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90 && missingET_e[0] < 100",

            #"selVBF_noBDT_VetoM5":"n_eminus == 1 && n_eplus == 1 && mass_ee > 110 && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90 && missingET_e[0] < 100 && bjetNo[0] > 0",
            ...
            #"selVBF_VetoM":"n_eminus == 1 && n_eplus == 1 && mass_ee > 110 && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && _FinalClassifier_BDT_bb > -0.2227",

            #"selVBF_VetoM1":"n_eminus == 1 && n_eplus == 1 && mass_ee > 110 && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && _FinalClassifier_BDT_bb > -0.2227",

            #"selVBF_VetoM2":"n_eminus == 1 && n_eplus == 1 && mass_ee > 110 && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && _FinalClassifier_BDT_bb > -0.2227",

            #"selVBF_VetoM3":"n_eminus == 1 && n_eplus == 1 && mass_ee > 110 && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90 && _FinalClassifier_BDT_bb > -0.2227",

            #"selVBF_VetoM4":"n_eminus == 1 && n_eplus == 1 && mass_ee > 110 && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90 && missingET_e[0] < 100 && _FinalClassifier_BDT_bb > -0.2227",
            
            #"selVBF_VetoM5":"n_eminus == 1 && n_eplus == 1 && mass_ee > 110 && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90 && missingET_e[0] < 100 && _FinalClassifier_BDT_bb > -0.2227 && bjetNo[0] > 0",
            ...
            #For p8 sample (ZH)
            #"sel_noBDT_eeHbb":"!(n_zedsub_e == 2 && (mass_Zee > 110)) && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20",

            #"sel_noBDT_eeH":"!(n_zedsub_e == 2 && (mass_Zee > 110)) && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6)",



            #"sel_eeHbb":"!(n_zedsub_e == 2 && (mass_Zee > 110)) && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && _FinalClassifier_BDT_ee > -0.1034",

            #"sel_eeH":"!(n_zedsub_e == 2 && (mass_Zee > 110)) && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && _FinalClassifier_BDT_ee > -0.1034",




            
            #"selVBF_noBDT_VetoM1":"!(n_zedsub_e == 2 && (mass_Zee > 110)) && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25",

            #"selVBF_noBDT_VetoM2":"!(n_zedsub_e == 2 && (mass_Zee > 110)) && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100",

            #"selVBF_noBDT_VetoM3":"!(n_zedsub_e == 2 && (mass_Zee > 110)) && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90",

            #"selVBF_noBDT_VetoM4":"!(n_zedsub_e == 2 && (mass_Zee > 110)) && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90 && missingET_e[0] < 100",

            #"selVBF_noBDT_VetoM5":"!(n_zedsub_e == 2 && (mass_Zee > 110)) && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90 && missingET_e[0] < 100 && bjetNo[0] > 0",
            ...
            #"selVBF_VetoM":"!(n_zedsub_e == 2 && (mass_Zee > 110)) && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && _FinalClassifier_BDT_bb > -0.2227",



            #"selVBF_VetoM1":"!(n_zedsub_e == 2 && (mass_Zee > 110)) && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && _FinalClassifier_BDT_bb > -0.2227",

            #"selVBF_VetoM2":"!(n_zedsub_e == 2 && (mass_Zee > 110)) && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && _FinalClassifier_BDT_bb > -0.2227",

            #"selVBF_VetoM3":"!(n_zedsub_e == 2 && (mass_Zee > 110)) && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90 && _FinalClassifier_BDT_bb > -0.2227",

            #"selVBF_VetoM4":"!(n_zedsub_e == 2 && (mass_Zee > 110)) && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90 && missingET_e[0] < 100 && _FinalClassifier_BDT_bb > -0.2227",

            #"selVBF_VetoM5":"!(n_zedsub_e == 2 && (mass_Zee > 110)) && (!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90 && missingET_e[0] < 100 && _FinalClassifier_BDT_bb > -0.2227 && bjetNo[0] > 0",
            ...
            #"sel_noBDT_eeHbb":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20",

            #"sel_noBDT_eeH":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6)",


            "sel_eeHbb":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && _FinalClassifier_BDT_ee > -0.1034",

            "sel_eeH":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && _FinalClassifier_BDT_ee > -0.1034",
            ...
            #"selVBF_noBDT_VetoM3":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90",

            #"selVBF_noBDT_VetoM4":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90 && missingET_e[0] < 100",

            #"selVBF_noBDT_VetoM5":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90 && missingET_e[0] < 100 && bjetNo[0] > 0",
            ...
            #"selVBF_VetoM":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && _FinalClassifier_BDT_bb > -0.2227",



            #"selVBF_VetoM1":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && _FinalClassifier_BDT_bb > -0.2227",

            #"selVBF_VetoM2":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && _FinalClassifier_BDT_bb > -0.2227",

            #"selVBF_VetoM3":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90 && _FinalClassifier_BDT_bb > -0.2227",

            #"selVBF_VetoM4":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90 && missingET_e[0] < 100 && _FinalClassifier_BDT_bb > -0.2227",

            #"selVBF_VetoM5":"(!(selected_muons_pt.size() == 2) && selected_electrons_pt.size() == 2) && !(!(selected_electrons_pt.size() == 2) && selected_muons_pt.size() == 2) && !(TMath::Abs(zed_leptonicE_m[0] - 91.188) < 6) && jetNo[0] > 2 && higgs_hadronic_subjets_btag.size() > 1 && higgs_hadronic_subjets_btag[0] == 1 && higgs_hadronic_subjets_btag[1] == 1 && higgs_hadronic_subjets_DeltaEta.size() > 0 && higgs_hadronic_subjets_DeltaEta[0] < 3 && jet_ht[0] > 20 && higgs_hadronic_subjets_acollPaPb[0] > 1.25 && jet_ht[0] > 100 && higgs_hadronic_m[0] > 90 && missingET_e[0] < 100 && _FinalClassifier_BDT_bb > -0.2227 && bjetNo[0] > 0",
            ...
            #"sel1":"n_eminus == 1 && n_eplus == 1 && mass_ee > 100", #Je groesser, desto unwahrscheinlicher fuer ZH event! Wir killen aber auch H->ZZ*->eeXX!!!
            #"sel2":"n_eminus == 1 && n_eplus == 1 && mass_ee > 110", #Das wird gewaehlt!
            ...
            #"sel1":"!(n_zedsub_e == 2 && (mass_Zee > 110))", #Je groesser, desto unwahrscheinlicher fuer ZH event! Wir killen aber auch H->ZZ*->eeXX!!!
...
variables = {
    ...
    "M_ee":{"name":"zed_leptonicE_m","title":"M_{ee} [GeV]","bin":60,"xmin":0,"xmax":350},
    "pT_ee":{"name":"zed_leptonicE_pt","title":"pT_{ee} [GeV]","bin":60,"xmin":0,"xmax":350},
    "M_H":{"name":"zed_leptonicE_recoil_m","title":"M_{H} [GeV]","bin":60,"xmin":0,"xmax":350},
    ...
    "FinalClassifier_BDT_ee":{"name":"_FinalClassifier_BDT_ee","title":"#beta_{ee}","bin":250,"xmin":-3,"xmax":1.2},
